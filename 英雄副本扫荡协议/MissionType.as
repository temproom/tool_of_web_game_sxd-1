package com.assist.server
{
   ...
   public class MissionType
   {
      ...
      {
         return !!Missions[param1] ? int(Missions[param1][0]) : 0;
      }
      ...
      {
         return !!Sections[param1] ? int(Sections[param1][2]) : 0;
      }
      ...
      {
         var _loc2_:String = !!Missions[param1] ? Missions[param1][7] : "";
      ...
      {
         return !!Missions[param1] ? int(Missions[param1][8]) : 0;
      }
      ...
      {
         return !!Missions[param1] ? int(Missions[param1][10]) : 0;
      }
      ...
      {
         return !!MissionToSecrets[param1] ? MissionToSecrets[param1] : null;
      }
      
      public static function getSecretMissionId(param1:int) : int
      {
         return !!MissionToSecrets[param1] ? int(MissionToSecrets[param1][0]) : 0;
      }
      
      public static function getSecretMissionReelId(param1:int) : int
      {
         return !!MissionToSecrets[param1] ? int(MissionToSecrets[param1][1]) : 0;
      }
      
      public static function getSecretMissionReelCount(param1:int) : int
      {
         return !!MissionToSecrets[param1] ? int(MissionToSecrets[param1][2]) : 0;
      }
      
      public static function getMissionAwardR208(param1:int) : Array
      {
         return !!MissionItemsR208[param1] ? MissionItemsR208[param1] : [];
      }
      ...
      public static function getSecretMissionMainId(param1:int) : int
      {
         ...
         {
            if(MissionToSecrets[_loc2_] && MissionToSecrets[_loc2_][0] == param1)
            {
               return parseInt(_loc2_);
            }
         }
      ...
      public static function getSecretMissionIdByReelId(param1:int) : int
      {
         ...
         for(_loc2_ in MissionToSecrets)
         {
            if(MissionToSecrets[_loc2_] && MissionToSecrets[_loc2_][1] == param1)
            {
               return parseInt(_loc2_);
            }
         }
