package com.protocols
{
   ...
   public class Mod_StXianFuSup_Base
   {
      ...
      public static const open:Object = {
         "module":119,
         "action":0,
         "request":[],
      ...
      public static const get_sign_up_list:Object = {
         "module":119,
         "action":2,
         "request":[],
      ...
      public static const get_player_ranking_by_list:Object = {
         "module":119,
         "action":3,
      ...
      public static const get_zhan_qu_data:Object = {
         "module":119,
         "action":4,
         "request":[],
         "response":[[Utils.ShortUtil,Utils.UByteUtil]]
      };
      
      public static const get_xian_fu_status:Object = {
         "module":119,
         "action":5,
         "request":[Utils.ShortUtil],
         "response":[[Utils.ShortUtil,[Utils.StringUtil,Utils.StringUtil,Utils.ShortUtil,Utils.ShortUtil,Utils.UByteUtil],Utils.UByteUtil,Utils.StringUtil],Utils.ShortUtil,Utils.UByteUtil]
      };
      ...
      public static const get_xian_fu_position_info:Object = {
         "module":119,
         "action":7,
         "request":[Utils.ShortUtil,Utils.ShortUtil],
         "response":[[Utils.UByteUtil,Utils.StringUtil,Utils.StringUtil,Utils.ShortUtil,Utils.ShortUtil],[Utils.UByteUtil,Utils.ShortUtil,Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil],Utils.UByteUtil]
      };
      ...
      public static const apply_change:Object = {
         "module":119,
         "action":9,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil]
      ...
      public static const notify:Object = {
         ...
         "action":15,
         "request":[],
         "response":[Utils.UByteUtil,Utils.UByteUtil,[Utils.IntUtil,Utils.StringUtil,Utils.ShortUtil],Utils.ShortUtil,[Utils.StringUtil,Utils.StringUtil]]
      };
      
      public static const finally_war_result:Object = {
         "module":119,
         "action":16,
         "request":[Utils.ShortUtil,Utils.ShortUtil],
         "response":[[Utils.StringUtil,Utils.StringUtil,Utils.ShortUtil,Utils.ShortUtil,Utils.UByteUtil,[Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil]]]
      };
      ...
      public static const notify_fight_over:Object = {
         "module":119,
         "action":18,
         "request":[],
         "response":[Utils.ShortUtil,[Utils.UByteUtil,Utils.ShortUtil,Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil],[Utils.UByteUtil,Utils.ShortUtil,Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil],Utils.IntUtil]
      };
      
      public static const notify_battle_war_list:Object = {
         "module":119,
         "action":19,
         "request":[],
         "response":[[Utils.ShortUtil,[Utils.UByteUtil,Utils.ShortUtil,Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil],[Utils.UByteUtil,Utils.ShortUtil,Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil]]]
      };
      
      public static const get_player_status:Object = {
         "module":119,
         "action":20,
         "request":[],
         "response":[Utils.UByteUtil]
