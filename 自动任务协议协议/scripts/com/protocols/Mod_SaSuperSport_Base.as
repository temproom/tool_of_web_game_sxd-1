package com.protocols
{
   ...
   public class Mod_SaSuperSport_Base
   {
      
      public static const SCORE_RACE:int = 0;
      
      public static const RANK_RACE:int = 1;
      
      public static const SUCCESS:int = 2;
      
      public static const ERROR:int = 3;
      
      public static const NOT_ENOUGTH_CHALLAGE_TIMES:int = 4;
      
      public static const NOT_ENOUGTH_SHENG_HUN:int = 5;
      
      public static const ITEM_PACK_FULL:int = 6;
      
      public static const TIMES_LIMIT:int = 7;
      
      public static const race_info:Object = {
         "module":384,
         "action":0,
         "request":[],
         "response":[Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,[Utils.IntUtil,Utils.ByteUtil,Utils.StringUtil,Utils.StringUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil]]
      };
      ...
      public static const rank_award:Object = {
         "module":384,
         "action":2,
         "request":[],
      ...
      public static const challage:Object = {
         "module":384,
         "action":3,
      ...
      public static const get_sport_report:Object = {
         "module":384,
         "action":6,
         "request":[],
         "response":[[Utils.IntUtil,Utils.IntUtil,Utils.StringUtil,Utils.StringUtil,Utils.StringUtil,Utils.IntUtil,Utils.StringUtil,Utils.StringUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.StringUtil,Utils.IntUtil]]
      };
      
      public static const new_sport_report:Object = {
         "module":384,
         "action":7,
         "request":[],
      ...
      public static const Actions:Array = ["race_info","rank_list","rank_award","challage","shop_info","buy","get_sport_report","new_sport_report","get_player_war_report"];
       
      
      public function Mod_SaSuperSport_Base()
      {
         super();
      }
   }
