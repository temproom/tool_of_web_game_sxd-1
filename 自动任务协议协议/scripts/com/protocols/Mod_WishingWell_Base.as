package com.protocols
{
   ...
   public class Mod_WishingWell_Base
   {
      ...
      public static const get_info:Object = {
         ...
         "action":0,
         "request":[],
         "response":[[Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil],[Utils.IntUtil,Utils.UByteUtil,Utils.IntUtil,Utils.UByteUtil,Utils.UByteUtil],Utils.ByteUtil,Utils.ByteUtil,Utils.ShortUtil,Utils.IntUtil,Utils.IntUtil]
      };
      
      public static const wishing:Object = {
         "module":325,
         "action":1,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil,Utils.IntUtil,Utils.UByteUtil,Utils.IntUtil,Utils.ByteUtil,Utils.ByteUtil]
      };
      
      public static const log:Object = {
         "module":325,
         "action":2,
         "request":[],
         "response":[[Utils.StringUtil,Utils.StringUtil,Utils.StringUtil,Utils.IntUtil,Utils.UByteUtil,Utils.IntUtil]]
      };
