package com.protocols
{
   ...
   public class Mod_StPiebridge_Base
   {
      ...
      public static const notify_game_start:Object = {
         ...
         "action":5,
         "request":[],
         "response":[Utils.IntUtil,[Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.StringUtil,Utils.StringUtil,Utils.StringUtil,Utils.ByteUtil,Utils.IntUtil,Utils.ShortUtil,Utils.ByteUtil],Utils.ByteUtil,Utils.ByteUtil,Utils.IntUtil]
      };
      ...
      public static const throw_dice:Object = {
         ...
         "action":7,
         "request":[],
         "response":[Utils.UByteUtil,Utils.IntUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.IntUtil,Utils.ByteUtil]
      };
      ...
      public static const notify_game_over:Object = {
         ...
         "action":9,
         "request":[],
         "response":[Utils.UByteUtil,[Utils.IntUtil,Utils.UByteUtil,Utils.ShortUtil],Utils.IntUtil,Utils.IntUtil]
      };
      ...
      public static const complete_play_animation:Object = {
         "module":245,
         "action":14,
         "request":[],
         "response":[Utils.UByteUtil]
