package com.protocols
{
   ...
   public class Mod_LendRole_Base
   {
      ...
      public static const friend_list:Object = {
         ...
         "action":1,
         "request":[],
         "response":[Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,[Utils.IntUtil,Utils.StringUtil,Utils.IntUtil],Utils.IntUtil,Utils.IntUtil]
      };
      
      public static const friend_role_list:Object = {
         "module":146,
         "action":2,
      ...
      public static const lend_role:Object = {
         "module":146,
         "action":3,
      ...
      public static const agree_lend_role:Object = {
         "module":146,
         "action":4,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil]
      ...
      public static const set_use_lend_role:Object = {
         "module":146,
         "action":5,
      ...
      public static const set_server_war_use_lend_role:Object = {
         "module":146,
         "action":6,
         "request":[Utils.ByteUtil],
         "response":[Utils.UByteUtil]
      ...
      public static const get_lend_role_info:Object = {
         "module":146,
         "action":7,
         "request":[Utils.ByteUtil],
         "response":[Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil]
      };
      ...
      public static const notify_request_lend_role:Object = {
         "module":146,
         "action":9,
         "request":[],
      ...
      public static const notify_apply_lend_role:Object = {
         "module":146,
         "action":10,
         "request":[],
