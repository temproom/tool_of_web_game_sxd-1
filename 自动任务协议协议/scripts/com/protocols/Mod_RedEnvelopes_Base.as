package com.protocols
{
   ...
   public class Mod_RedEnvelopes_Base
   {
      ...
      public static const get_envelopes_info:Object = {
         "module":43,
         "action":0,
         "request":[],
         "response":[[Utils.LongUtil,Utils.IntUtil,Utils.IntUtil]]
      };
      
      public static const get_envelope:Object = {
         "module":43,
         "action":1,
