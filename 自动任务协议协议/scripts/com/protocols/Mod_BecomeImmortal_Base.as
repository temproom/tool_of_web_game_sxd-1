package com.protocols
{
   ...
   public class Mod_BecomeImmortal_Base
   {
      ...
      public static const get_become_immortal_data:Object = {
         "module":134,
         "action":0,
         "request":[],
      ...
      public static const update_become_immortal:Object = {
         "module":134,
         "action":1,
         "request":[],
      ...
      public static const get_training_add:Object = {
         "module":134,
         "action":3,
         "request":[],
      ...
      public static const auto_update_become_immortal:Object = {
         "module":134,
         "action":7,
         "request":[],
         "response":[Utils.UByteUtil,[Utils.ShortUtil],Utils.IntUtil]
      ...
      public static const get_player_3_way:Object = {
         "module":134,
         "action":8,
         "request":[],
      ...
      public static const notify_become_immortal:Object = {
         "module":134,
         "action":9,
         "request":[],
