package com.protocols
{
   ...
   public class Mod_WinterMission_Base
   {
      ...
      public static const FUHUO_TIMES_FULL:int = 2;
      ...
      public static const enter_mission:Object = {
         ...
         "action":0,
         "request":[],
         "response":[[Utils.IntUtil,Utils.ByteUtil],Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil]
      };
      ...
      public static const get_ranking:Object = {
         ...
         "action":1,
         "request":[],
         "response":[[Utils.StringUtil,Utils.StringUtil,Utils.StringUtil,Utils.IntUtil,Utils.ByteUtil],Utils.IntUtil,Utils.IntUtil]
      };
      ...
      public static const continue_fight:Object = {
         "module":128,
         "action":3,
         "request":[],
      ...
      public static const notify_fight_result:Object = {
         ...
         "action":4,
         "request":[],
         "response":[Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil,[Utils.IntUtil],Utils.IntUtil]
      };
      
      public static const get_lose_war_report:Object = {
         "module":128,
         "action":5,
      ...
      public static const exit_mission:Object = {
         "module":128,
         "action":6,
         "request":[],
         "response":[]
      ...
      public static const mission_info:Object = {
         "module":128,
         "action":7,
         "request":[],
      ...
      public static const Actions:Array = ["enter_mission","get_ranking","start_fight","continue_fight","notify_fight_result","get_lose_war_report","exit_mission","mission_info","get_activity_time"];
       
      
      public function Mod_WinterMission_Base()
      {
         super();
      }
   }
