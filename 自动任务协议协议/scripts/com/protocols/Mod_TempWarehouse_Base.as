package com.protocols
{
   ...
   public class Mod_TempWarehouse_Base
   {
      ...
      public static const get_item_list:Object = {
         "module":141,
         "action":0,
         "request":[Utils.UByteUtil],
         "response":[[Utils.IntUtil,Utils.IntUtil,Utils.ShortUtil,Utils.IntUtil],Utils.UByteUtil]
      };
      
      public static const pickup_item_to_package:Object = {
         "module":141,
         "action":1,
      ...
      public static const temp_warehouse_open_and_close_time:Object = {
         "module":141,
         "action":3,
         "request":[],
