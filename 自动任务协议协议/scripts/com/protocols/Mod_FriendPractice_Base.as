package com.protocols
{
   ...
   public class Mod_FriendPractice_Base
   {
      ...
      public static const get_info:Object = {
         ...
         "action":0,
         "request":[],
         "response":[[Utils.IntUtil,Utils.StringUtil,Utils.IntUtil],Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil,Utils.IntUtil,Utils.StringUtil,Utils.IntUtil]
      };
      ...
      public static const revoke_invite:Object = {
         "module":296,
         "action":2,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const agree_invite:Object = {
         "module":296,
         "action":4,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil]
      ...
      public static const notify_mailer:Object = {
         "module":296,
         "action":6,
         "request":[],
