package com.protocols
{
   ...
   public class Mod_ShenGun_Base
   {
      ...
      public static const shen_gun_info:Object = {
         "module":202,
         "action":0,
         "request":[],
      ...
      public static const all_server_shen_gun_count:Object = {
         "module":202,
         "action":1,
         "request":[],
      ...
      public static const get_groupon_award_info:Object = {
         "module":202,
         "action":2,
         "request":[],
      ...
      public static const receive_groupon_award:Object = {
         "module":202,
         "action":3,
         "request":[],
