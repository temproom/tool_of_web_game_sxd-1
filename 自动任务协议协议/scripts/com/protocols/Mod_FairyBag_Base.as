package com.protocols
{
   ...
   public class Mod_FairyBag_Base
   {
      ...
      public static const get_fairy_bag_info:Object = {
         "module":354,
         "action":0,
         "request":[],
         "response":[Utils.LongUtil,Utils.UByteUtil]
      };
      
      public static const get_coins:Object = {
         "module":354,
         "action":1,
