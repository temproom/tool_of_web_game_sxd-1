package com.protocols
{
   ...
   public class Mod_StcLogin_Base
   {
      ...
      public static const notify_change_status:Object = {
         "module":96,
         "action":2,
         "request":[],
      ...
      public static const get_st_server_host:Object = {
         "module":96,
         "action":3,
         "request":[],
      ...
      public static const get_st_bulletin_info:Object = {
         "module":96,
         "action":4,
         "request":[],
      ...
      public static const st_bulletin_info:Object = {
         "module":96,
         "action":5,
         "request":[],
