package com.protocols
{
   ...
   public class Mod_StUnionMagic_Base
   {
      ...
      public static const get_st_union_magic_list:Object = {
         "module":183,
         "action":0,
         "request":[Utils.UByteUtil],
         "response":[Utils.UByteUtil,[Utils.IntUtil,Utils.ShortUtil],Utils.IntUtil]
      };
