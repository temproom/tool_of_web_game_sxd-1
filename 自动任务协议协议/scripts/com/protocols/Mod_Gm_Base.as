package com.protocols
{
   ...
   public class Mod_Gm_Base
   {
      ...
      public static const get_remain_submit_times:Object = {
         "module":27,
         "action":0,
         "request":[],
      ...
      public static const submit_bug:Object = {
         "module":27,
         "action":1,
      ...
      public static const get_bug_list:Object = {
         "module":27,
         "action":2,
         "request":[],
