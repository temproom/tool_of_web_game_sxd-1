package com.protocols
{
   ...
   public class Mod_FindKey_Base
   {
      ...
      public static const find_key_info:Object = {
         "module":249,
         "action":0,
         "request":[],
         "response":[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,[Utils.ByteUtil,Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil,Utils.ByteUtil],Utils.IntUtil,Utils.IntUtil,Utils.IntUtil]
      };
      
      public static const buy_find_times:Object = {
         "module":249,
         "action":1,
         "request":[],
      ...
      public static const is_pass:Object = {
         "module":249,
         "action":5,
         "request":[],
