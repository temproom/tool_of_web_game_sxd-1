package com.protocols
{
   ...
   public class Mod_StTown_Base
   {
      ...
      public static const notify_level_town:Object = {
         "module":95,
         "action":3,
         "request":[],
      ...
      public static const notify_image_change:Object = {
         ...
         "action":7,
         "request":[],
         "response":[Utils.IntUtil,Utils.ByteUtil,Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,[Utils.IntUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.ShortUtil]]
      };
