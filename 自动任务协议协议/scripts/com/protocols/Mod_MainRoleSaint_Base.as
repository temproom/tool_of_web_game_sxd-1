package com.protocols
{
   ...
   public class Mod_MainRoleSaint_Base
   {
      ...
      public static const get_info:Object = {
         ...
         "action":0,
         "request":[],
         "response":[[Utils.ByteUtil,Utils.LongUtil],Utils.UByteUtil,Utils.UByteUtil,Utils.IntUtil]
      };
      
      public static const saint:Object = {
         "module":262,
         "action":1,
         "request":[],
      ...
      public static const get_saint_flag:Object = {
         "module":262,
         "action":2,
         "request":[],
         "response":[Utils.UByteUtil]
