package com.protocols
{
   ...
   public class Mod_Email_Base
   {
      ...
      public static const FATE_PACKAGE_FULL:int = 14;
      
      public static const LINK_FATE_PACK_FULL:int = 15;
      
      public static const ONE:int = 16;
      
      public static const ALL:int = 17;
      
      public static const HAVE_ATTACHMENT:int = 18;
      
      public static const CAN_NOT_DELETE:int = 19;
      
      public static const NEW_EMAIL:int = 20;
      
      public static const NO_AWARD:int = 21;
      
      public static const get_email_info:Object = {
         "module":345,
         "action":0,
         "request":[],
      ...
      public static const read_email:Object = {
         "module":345,
         "action":1,
      ...
      public static const get_attachment_award:Object = {
         "module":345,
         "action":2,
         "request":[Utils.IntUtil],
      ...
      public static const delete_email:Object = {
         "module":345,
         "action":3,
      ...
      public static const notify_new_email:Object = {
         "module":345,
         "action":4,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const is_have_new_email:Object = {
         "module":345,
         "action":5,
         "request":[],
         "response":[Utils.UByteUtil]
