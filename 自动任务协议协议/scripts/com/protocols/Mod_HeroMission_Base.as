package com.protocols
{
   ...
   public class Mod_HeroMission_Base
   {
      ...
      public static const get_special_hero_mission_list:Object = {
         "module":35,
         "action":8,
         "request":[],
      ...
      public static const get_hero_mission_finish_info:Object = {
         "module":35,
         "action":9,
         "request":[Utils.IntUtil],
         "response":[Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil,Utils.StringUtil]
      };
