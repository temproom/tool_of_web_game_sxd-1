package com.protocols
{
   ...
   public class Mod_NewServerVariesFunds_Base
   {
      ...
      public static const activity_info:Object = {
         ...
         "action":1,
         "request":[],
         "response":[Utils.ByteUtil,[Utils.IntUtil,[Utils.IntUtil,Utils.IntUtil],Utils.ByteUtil],Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil]
      };
      
      public static const buy_new_server_varies_funds:Object = {
         "module":326,
         "action":2,
         "request":[],
      ...
      public static const get_new_server_varies_funds:Object = {
         "module":326,
         "action":3,
      ...
      public static const open_peal:Object = {
         "module":326,
         "action":4,
         "request":[],
         "response":[Utils.UByteUtil]
