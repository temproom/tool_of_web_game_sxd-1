package com.protocols
{
   ...
   public class Mod_StAltar_Base
   {
      ...
      public static const get_altar_info:Object = {
         "module":263,
         "action":0,
         "request":[],
         "response":[Utils.UByteUtil,Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,[Utils.ShortUtil,Utils.StringUtil,Utils.ShortUtil,Utils.IntUtil],Utils.ByteUtil,Utils.ByteUtil]
      };
      ...
      public static const quick_complete_quest:Object = {
         "module":263,
         "action":4,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil]
      ...
      public static const notify_quest_status:Object = {
         "module":263,
         "action":7,
         "request":[],
