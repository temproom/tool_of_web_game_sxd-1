package com.protocols
{
   ...
   public class Mod_DunhuangTreasure_Base
   {
      ...
      public static const FATE_PACK_FULL:int = 19;
      
      public static const LING_BAO_PACK_FULL:int = 20;
      
      public static const NO_GIFT:int = 21;
      
      public static const get_dunhuang_treasure_info:Object = {
         "module":356,
         "action":0,
         "request":[],
         "response":[[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil],Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,[Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil],Utils.IntUtil,Utils.IntUtil]
      };
      
      public static const open_treasure:Object = {
         "module":356,
         "action":1,
