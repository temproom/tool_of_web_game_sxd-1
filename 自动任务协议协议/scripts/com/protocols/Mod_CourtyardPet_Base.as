package com.protocols
{
   ...
   public class Mod_CourtyardPet_Base
   {
      ...
      public static const get_courtyard_pet_list:Object = {
         ...
         "action":2,
         "request":[],
         "response":[[Utils.IntUtil,Utils.ByteUtil,Utils.ShortUtil,Utils.IntUtil,Utils.ShortUtil,Utils.IntUtil],[Utils.IntUtil,Utils.ByteUtil,Utils.ShortUtil],[Utils.IntUtil]]
      };
      ...
      public static const merge:Object = {
         ...
         "response":[Utils.UByteUtil,Utils.IntUtil,Utils.ByteUtil,Utils.ShortUtil,Utils.IntUtil,Utils.ShortUtil]
      };
      ...
      public static const feed:Object = {
         ...
         "response":[Utils.UByteUtil,Utils.IntUtil,Utils.ByteUtil,Utils.ShortUtil,Utils.IntUtil,Utils.ShortUtil,Utils.IntUtil,Utils.ByteUtil,Utils.ShortUtil,Utils.IntUtil,Utils.ShortUtil]
      };
      ...
      public static const get_quest_list:Object = {
         ...
         "action":5,
         "request":[],
         "response":[Utils.UByteUtil,Utils.ByteUtil,[Utils.IntUtil,[Utils.ShortUtil,Utils.ShortUtil,Utils.ShortUtil,[Utils.ShortUtil]],Utils.UByteUtil,Utils.UByteUtil,Utils.ByteUtil,Utils.IntUtil,Utils.UByteUtil,[Utils.ShortUtil],[Utils.ShortUtil,Utils.IntUtil],[Utils.ShortUtil],Utils.UByteUtil,[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil],Utils.IntUtil],Utils.ByteUtil,Utils.ByteUtil,Utils.ByteUtil]
      };
      
      public static const reload:Object = {
         "module":216,
         "action":6,
      ...
      public static const get_courtyard_normal_pet_list:Object = {
         "module":216,
         "action":9,
         "request":[],
         "response":[[Utils.IntUtil,Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil]]
      };
      
      public static const lucky_call:Object = {
         "module":216,
         "action":10,
         "request":[],
         "response":[Utils.UByteUtil,[Utils.ShortUtil,Utils.UByteUtil]]
      ...
      public static const one_key_feed:Object = {
         "module":216,
         "action":11,
         "request":[Utils.IntUtil,Utils.IntUtil],
         "response":[Utils.UByteUtil,Utils.IntUtil,Utils.ByteUtil,Utils.ShortUtil,Utils.IntUtil,Utils.ShortUtil,Utils.IntUtil,Utils.ByteUtil,Utils.ShortUtil,Utils.IntUtil,Utils.ShortUtil]
      ...
      public static const exchange_pet:Object = {
         "module":216,
         "action":12,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil]
      ...
      public static const set_auto_quest_pet:Object = {
         "module":216,
         "action":13,
      ...
      public static const set_auto_get_award:Object = {
         "module":216,
         "action":14,
      ...
      public static const auto_info:Object = {
         "module":216,
         "action":15,
         "request":[],
         "response":[Utils.ByteUtil,[Utils.ByteUtil,Utils.ByteUtil],Utils.ByteUtil,[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,[Utils.IntUtil,Utils.IntUtil]]]
      };
      
      public static const buy_pet:Object = {
         "module":216,
         "action":16,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil]
