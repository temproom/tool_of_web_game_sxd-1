package com.protocols
{
   ...
   public class Mod_ChristmasGift_Base
   {
      ...
      public static const NOT_ENOUGTH_CHARGE_INGOT:int = 11;
      
      public static const NOT_ENOUGH_DAOYUAN:int = 12;
      
      public static const get_sock_info:Object = {
         "module":331,
         "action":0,
         "request":[],
      ...
      public static const get_sock:Object = {
         "module":331,
         "action":1,
         "request":[],
      ...
      public static const shop_info:Object = {
         ...
         "action":3,
         "request":[],
         "response":[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,[Utils.ShortUtil,Utils.IntUtil,Utils.IntUtil,Utils.ShortUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil]]
      };
