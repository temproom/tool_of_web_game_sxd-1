package com.protocols
{
   ...
   public class Mod_Groupon_Base
   {
      ...
      public static const get_groupon_status:Object = {
         "module":154,
         "action":0,
         "request":[],
      ...
      public static const get_groupon_info:Object = {
         "module":154,
         "action":1,
         "request":[],
      ...
      public static const get_player_groupon_info:Object = {
         "module":154,
         "action":2,
         "request":[],
         "response":[[Utils.ShortUtil,Utils.UByteUtil,Utils.IntUtil]]
      };
      ...
      public static const notify_player_have_cha_ye_dan:Object = {
         "module":154,
         "action":5,
         "request":[],
      ...
      public static const notify_player_have_cha_ye_dan_hua_lun:Object = {
         "module":154,
         "action":6,
         "request":[],
         "response":[Utils.IntUtil]
      ...
      public static const get_player_is_sage:Object = {
         "module":154,
         "action":7,
         "request":[],
         "response":[Utils.UByteUtil]
