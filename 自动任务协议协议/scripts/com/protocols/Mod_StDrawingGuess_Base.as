package com.protocols
{
   ...
   public class Mod_StDrawingGuess_Base
   {
      ...
      public static const get_drawing_guess_info:Object = {
         "module":363,
         "action":0,
         "request":[],
      ...
      public static const notify_match_num_change:Object = {
         "module":363,
         "action":3,
         "request":[],
      ...
      public static const notify_match_result:Object = {
         "module":363,
         "action":4,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const notify_player_info:Object = {
         "module":363,
         "action":5,
         "request":[],
         "response":[[Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.StringUtil,Utils.StringUtil],Utils.IntUtil]
      };
      
      public static const notify_start:Object = {
         "module":363,
         "action":6,
         "request":[],
      ...
      public static const notify_end:Object = {
         ...
         "action":7,
         "request":[],
         "response":[Utils.UByteUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil]
      };
      
      public static const use_prop:Object = {
         "module":363,
         "action":8,
      ...
      public static const receive_picture:Object = {
         "module":363,
         "action":10,
         "request":[],
      ...
      public static const notify_revoke:Object = {
         "module":363,
         "action":16,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const notify_open_close:Object = {
         "module":363,
         "action":17,
         "request":[],
         "response":[Utils.UByteUtil]
