package com.protocols
{
   ...
   public class Mod_LanternsLottery_Base
   {
      ...
      public static const CHAOS_ITEM_PACK_FULL:int = 7;
      
      public static const ITEM_PACK_FULL:int = 8;
      
      public static const NOT_ENOUGH_WICK:int = 9;
      
      public static const get_lanterns_lottery_info:Object = {
         "module":302,
         "action":0,
         "request":[],
      ...
      public static const Actions:Array = ["get_lanterns_lottery_info","start_lottery","refresh_award","get_award","get_exchange_info","exchange","notify_get_award"];
