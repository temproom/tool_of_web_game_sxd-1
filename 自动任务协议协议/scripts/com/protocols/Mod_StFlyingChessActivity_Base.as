package com.protocols
{
   ...
   public class Mod_StFlyingChessActivity_Base
   {
      ...
      public static const notify_game_start:Object = {
         ...
         "action":3,
         "request":[],
         "response":[Utils.IntUtil,[Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil,Utils.StringUtil,Utils.StringUtil,Utils.StringUtil,[Utils.ByteUtil,Utils.ShortUtil,Utils.UByteUtil]],[Utils.ByteUtil,Utils.ShortUtil],Utils.IntUtil]
      };
      
      public static const notify_count_change:Object = {
         "module":190,
         "action":4,
         "request":[],
      ...
      public static const throw_dice:Object = {
         "module":190,
         "action":5,
      ...
      public static const cancel_hosting:Object = {
         "module":190,
         "action":7,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const notify_current_round:Object = {
         "module":190,
         "action":8,
         "request":[],
         "response":[Utils.ByteUtil,[Utils.ByteUtil,Utils.ShortUtil],[Utils.ShortUtil],[Utils.IntUtil,Utils.ByteUtil,Utils.ShortUtil,Utils.ShortUtil],[Utils.ByteUtil,Utils.ShortUtil]]
      };
      
      public static const current_round_display_finish:Object = {
         "module":190,
         "action":9,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil]
      ...
      public static const notify_throw_dice:Object = {
         "module":190,
         "action":10,
         "request":[],
      ...
      public static const enter_game_map:Object = {
         "module":190,
         "action":14,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const exit_game_map:Object = {
         "module":190,
         "action":15,
         "request":[],
         "response":[Utils.UByteUtil]
