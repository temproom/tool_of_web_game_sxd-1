package com.protocols
{
   ...
   public class Mod_SignIn_Base
   {
      ...
      public static const get_sign_in_info:Object = {
         ...
         "action":0,
         "request":[],
         "response":[Utils.UByteUtil,Utils.IntUtil,[Utils.IntUtil],[Utils.UByteUtil,Utils.UByteUtil],Utils.IntUtil,Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil]
      };
      
      public static const get_continue_award:Object = {
         "module":89,
         "action":1,
         "request":[],
      ...
      public static const player_sign_in:Object = {
         ...
         "action":2,
         "request":[],
         "response":[Utils.UByteUtil,[Utils.IntUtil],[Utils.UByteUtil,Utils.UByteUtil],Utils.IntUtil,Utils.UByteUtil,Utils.IntUtil]
      };
      
      public static const repair_sign_in:Object = {
         "module":89,
         "action":3,
         "request":[],
         "response":[Utils.UByteUtil,[Utils.IntUtil],[Utils.UByteUtil,Utils.UByteUtil],Utils.IntUtil,Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil]
      };
