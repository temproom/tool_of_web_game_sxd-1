package com.protocols
{
   ...
   public class Mod_StZhaoCha_Base
   {
      ...
      public static const get_st_zhao_cha_status:Object = {
         "module":162,
         "action":0,
         "request":[],
      ...
      public static const join_st_zhao_cha:Object = {
         "module":162,
         "action":1,
         "request":[],
      ...
      public static const exit_st_zhao_cha:Object = {
         "module":162,
         "action":2,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const notify_start_game:Object = {
         "module":162,
         "action":3,
         "request":[],
         "response":[Utils.ShortUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil]
      };
      
      public static const notify_image_number:Object = {
         "module":162,
         "action":4,
         "request":[],
      ...
      public static const pick_the_diff:Object = {
         "module":162,
         "action":5,
      ...
      public static const notify_game_result:Object = {
         "module":162,
         "action":6,
         "request":[],
      ...
      public static const get_player_item:Object = {
         "module":162,
         "action":8,
         "request":[],
      ...
      public static const get_player_ranking:Object = {
         "module":162,
         "action":9,
         "request":[],
         "response":[[Utils.ShortUtil,Utils.StringUtil,Utils.IntUtil]]
      };
      
      public static const notify_compititor_player_info:Object = {
         "module":162,
         "action":10,
         "request":[],
      ...
      public static const notify_10_end_time:Object = {
         "module":162,
         "action":11,
         "request":[],
         "response":[Utils.UByteUtil]
