package com.protocols
{
   ...
   public class Mod_Gamable_Base
   {
      ...
      public static const get_gamable_info:Object = {
         "module":112,
         "action":0,
         "request":[],
         "response":[[Utils.IntUtil],[Utils.IntUtil],Utils.UByteUtil,Utils.ShortUtil]
      };
      ...
      public static const notify_gamable_live:Object = {
         "module":112,
         "action":2,
         "request":[],
      ...
      public static const player_gamable_offline:Object = {
         "module":112,
         "action":3,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const player_gamable_online:Object = {
         "module":112,
         "action":4,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const notify_player_have_yutu:Object = {
         "module":112,
         "action":6,
         "request":[],
      ...
      public static const get_player_award_flag:Object = {
         "module":112,
         "action":7,
         "request":[],
         "response":[Utils.UByteUtil]
