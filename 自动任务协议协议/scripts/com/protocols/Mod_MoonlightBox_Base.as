package com.protocols
{
   ...
   public class Mod_MoonlightBox_Base
   {
      ...
      public static const NO_ENOUGH_GAIN_COUNT:int = 13;
      
      public static const get_moonlight_box_info:Object = {
         "module":348,
         "action":0,
         "request":[],
         "response":[[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil],Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil],Utils.ByteUtil,Utils.IntUtil,Utils.ByteUtil,Utils.IntUtil]
      };
      
      public static const rock:Object = {
         "module":348,
         "action":1,
         "request":[],
      ...
      public static const get_score:Object = {
         "module":348,
         "action":2,
         "request":[],
      ...
      public static const Actions:Array = ["get_moonlight_box_info","rock","get_score","get_score_award","get_big_award"];
