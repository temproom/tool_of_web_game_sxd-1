package com.protocols
{
   ...
   public class Mod_ChargeBack_Base
   {
      ...
      public static const open_charge_back:Object = {
         "module":155,
         "action":0,
         "request":[],
         "response":[Utils.IntUtil,[Utils.IntUtil,Utils.UByteUtil],Utils.IntUtil,Utils.UByteUtil]
      };
      ...
      public static const notify_new_can_get:Object = {
         "module":155,
         "action":2,
         "request":[],
      ...
      public static const get_charge_back_activity_time:Object = {
         "module":155,
         "action":3,
         "request":[],
      ...
      public static const get_player_freedom_info:Object = {
         "module":155,
         "action":5,
         "request":[],
      ...
      public static const get_mascot_befall_time:Object = {
         "module":155,
         "action":6,
         "request":[],
      ...
      public static const get_player_mascot_befall_info:Object = {
         "module":155,
         "action":7,
         "request":[],
      ...
      public static const activate_fuction_of_mascot_befall:Object = {
         "module":155,
         "action":8,
      ...
      public static const get_world_charge_award_info:Object = {
         "module":155,
         "action":9,
         "request":[],
      ...
      public static const get_world_charge_award:Object = {
         "module":155,
         "action":10,
         "request":[],
         "response":[Utils.UByteUtil]
