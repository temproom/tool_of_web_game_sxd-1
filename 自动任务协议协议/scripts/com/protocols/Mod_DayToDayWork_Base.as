package com.protocols
{
   ...
   public class Mod_DayToDayWork_Base
   {
      ...
      public static const get_act_info:Object = {
         "module":165,
         "action":0,
         "request":[],
      ...
      public static const get_quest_list:Object = {
         ...
         "action":1,
         "request":[],
         "response":[[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil,Utils.ByteUtil,[Utils.IntUtil,Utils.IntUtil]],Utils.IntUtil]
      };
      ...
      public static const get_drawing_award_list:Object = {
         "module":165,
         "action":3,
         "request":[],
      ...
      public static const drawing:Object = {
         "module":165,
         "action":4,
         "request":[],
