package com.protocols
{
   ...
   public class Mod_LotusLamp_Base
   {
      ...
      public static const enter_activity:Object = {
         "module":140,
         "action":1,
         "request":[],
         "response":[Utils.ByteUtil,Utils.IntUtil,Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil]
      };
      
      public static const exit_activity:Object = {
         "module":140,
         "action":2,
         "request":[],
      ...
      public static const bloom:Object = {
         "module":140,
         "action":3,
         "request":[],
         "response":[Utils.UByteUtil,Utils.UByteUtil,Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil]
      };
      
      public static const other_bloom_notify:Object = {
         "module":140,
         "action":4,
         "request":[],
