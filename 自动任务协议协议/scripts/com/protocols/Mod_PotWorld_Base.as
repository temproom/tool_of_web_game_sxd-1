package com.protocols
{
   ...
   public class Mod_PotWorld_Base
   {
      ...
      public static const get_store_info:Object = {
         "module":235,
         "action":2,
         "request":[Utils.IntUtil],
         "response":[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil]]
      };
      
      public static const get_fu_info:Object = {
         "module":235,
         "action":4,
         "request":[],
         "response":[[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil,[Utils.IntUtil,Utils.IntUtil,Utils.LongUtil],Utils.UByteUtil]]
      };
      
      public static const get_merge_info:Object = {
         "module":235,
         "action":5,
         "request":[Utils.IntUtil],
      ...
      public static const get_pack_info:Object = {
         "module":235,
         "action":6,
         "request":[],
      ...
      public static const move_item:Object = {
         "module":235,
         "action":7,
      ...
      public static const upgrade_building:Object = {
         "module":235,
         "action":8,
         "request":[Utils.IntUtil],
      ...
      public static const merge_item:Object = {
         "module":235,
         "action":10,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil]
      ...
      public static const unlock_item:Object = {
         "module":235,
         "action":11,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil,Utils.IntUtil]
      ...
      public static const sort_pot_world_pack:Object = {
         "module":235,
         "action":12,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const get_player_fu_list:Object = {
         "module":235,
         "action":13,
         "request":[],
      ...
      public static const upgrade_fu:Object = {
         "module":235,
         "action":14,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil]
      ...
      public static const get_merge_item:Object = {
         "module":235,
         "action":15,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil]
      ...
      public static const clean_pack_item:Object = {
         "module":235,
         "action":16,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil]
      ...
      public static const get_forever_zhu_fu_list:Object = {
         "module":235,
         "action":17,
         "request":[],
      ...
      public static const do_forever:Object = {
         "module":235,
         "action":18,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil]
