package com.protocols
{
   ...
   public class Mod_TwoCardMeet_Base
   {
      ...
      public static const get_info:Object = {
         ...
         "action":0,
         "request":[],
         "response":[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil,[Utils.ShortUtil,Utils.ShortUtil]]
      };
      ...
      public static const open_crad:Object = {
         "module":283,
         "action":2,
      ...
      public static const notify_all_player:Object = {
         "module":283,
         "action":5,
         "request":[],
