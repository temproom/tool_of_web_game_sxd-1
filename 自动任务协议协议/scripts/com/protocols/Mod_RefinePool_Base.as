package com.protocols
{
   ...
   public class Mod_RefinePool_Base
   {
      ...
      public static const REFINE_1:int = 5;
      
      public static const REFINE_2:int = 6;
      
      public static const COINS:int = 7;
      
      public static const INGOT:int = 8;
      
      public static const NORMAL:int = 9;
      
      public static const ONE_KEY:int = 10;
      
      public static const SUCCESS:int = 11;
      
      public static const LACK_OF_COINS:int = 12;
      
      public static const LACK_OF_INGOT:int = 13;
      ...
      public static const notify_refine_status_change:Object = {
         "module":282,
         "action":2,
         "request":[],
         "response":[[Utils.ByteUtil,Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil]]
      };
