package com.protocols
{
   ...
   public class Mod_AutoActivity_Base
   {
      ...
      public static const auto_activity_info:Object = {
         "module":121,
         "action":0,
         "request":[],
      ...
      public static const set_auto_activity:Object = {
         "module":121,
         "action":1,
      ...
      public static const all_select:Object = {
         "module":121,
         "action":2,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const all_cancel:Object = {
         "module":121,
         "action":3,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const is_get_mobile_assistant_bind_award:Object = {
         "module":121,
         "action":4,
         "request":[],
      ...
      public static const get_mobile_assistant_bind_award:Object = {
         "module":121,
         "action":5,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const get_phone_number_bind_award:Object = {
         "module":121,
         "action":6,
         "request":[],
         "response":[Utils.UByteUtil]
