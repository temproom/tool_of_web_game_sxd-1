package com.protocols
{
   ...
   public class Mod_Library_Base
   {
      ...
      public static const get_library_info:Object = {
         ...
         "action":1,
         "request":[],
         "response":[[Utils.ByteUtil,Utils.ShortUtil],Utils.ShortUtil,Utils.ShortUtil,Utils.ShortUtil,Utils.UByteUtil]
      };
      
      public static const up_library_level:Object = {
         "module":85,
         "action":2,
      ...
      public static const activate_library_upgrade:Object = {
         "module":85,
         "action":4,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const get_artifact_stunt_info:Object = {
         ...
         "action":5,
         "request":[],
         "response":[[Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil,Utils.ByteUtil]]
      };
      ...
      public static const Actions:Array = ["get_library_info","up_library_level","use_stunt_skill","activate_library_upgrade","get_artifact_stunt_info","get_tian_shi_stunt_info"];
