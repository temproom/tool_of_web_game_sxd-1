package com.protocols
{
   ...
   public class Mod_Adventure_Base
   {
      ...
      public static const get_adventure_open_time:Object = {
         "module":73,
         "action":0,
         "request":[],
      ...
      public static const open_adventure:Object = {
         "module":73,
         "action":1,
         "request":[],
      ...
      public static const create_adventure_team:Object = {
         "module":73,
         "action":3,
         "request":[],
      ...
      public static const dissolve_adventure_team:Object = {
         "module":73,
         "action":4,
      ...
      public static const join_adventure_team:Object = {
         "module":73,
         "action":5,
         "request":[Utils.IntUtil],
      ...
      public static const exit_adventure_team:Object = {
         "module":73,
         "action":6,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil]
      ...
      public static const close_adventure:Object = {
         "module":73,
         "action":7,
         "request":[],
         "response":[]
      ...
      public static const walk_adventure_grid:Object = {
         "module":73,
         "action":8,
      ...
      public static const get_adventure_info:Object = {
         "module":73,
         "action":16,
         "request":[Utils.IntUtil],
