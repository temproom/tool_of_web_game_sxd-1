package com.protocols
{
   ...
   public class Mod_Turnplate_Base
   {
      ...
      public static const get_turnplate_status:Object = {
         "module":150,
         "action":0,
         "request":[],
      ...
      public static const get_player_turnplate:Object = {
         "module":150,
         "action":1,
         "request":[],
         "response":[[Utils.ShortUtil,[Utils.ShortUtil,Utils.IntUtil,Utils.IntUtil]],Utils.ShortUtil,Utils.ShortUtil,Utils.ShortUtil,Utils.IntUtil,Utils.ShortUtil,Utils.ShortUtil,[Utils.ShortUtil],Utils.UByteUtil,Utils.ShortUtil,Utils.LongUtil,Utils.IntUtil,[Utils.IntUtil,Utils.ByteUtil]]
      };
      
      public static const do_turnplate:Object = {
         "module":150,
         "action":2,
         "request":[],
         "response":[Utils.UByteUtil,[Utils.ShortUtil],Utils.ShortUtil,Utils.ShortUtil,Utils.IntUtil,Utils.ShortUtil,Utils.UByteUtil,Utils.ShortUtil]
      };
      ...
      public static const exchange_list:Object = {
         ...
         "action":5,
         "request":[],
         "response":[[Utils.ByteUtil,Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil],Utils.IntUtil,Utils.ByteUtil,Utils.IntUtil,Utils.ByteUtil]
      };
      
      public static const notify_turnplate_award:Object = {
         "module":150,
         "action":6,
         "request":[],
      ...
      public static const get_reel:Object = {
         "module":150,
         "action":7,
         "request":[],
      ...
      public static const notify_all_server_star_count:Object = {
         "module":150,
         "action":8,
         "request":[],
