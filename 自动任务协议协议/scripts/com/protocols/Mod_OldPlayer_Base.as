package com.protocols
{
   ...
   public class Mod_OldPlayer_Base
   {
      ...
      public static const get_old_player_info:Object = {
         "module":88,
         "action":1,
         "request":[],
         "response":[Utils.ByteUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.StringUtil]
      };
      
      public static const receive_old_player_gift:Object = {
         "module":88,
         "action":2,
         "request":[],
      ...
      public static const notify_receive_old_player_gift_result:Object = {
         "module":88,
         "action":3,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const exchange_Invitation_award:Object = {
         "module":88,
         "action":4,
      ...
      public static const notify_exchange_Invitation_award_result:Object = {
         "module":88,
         "action":5,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const notify_old_player_status:Object = {
         "module":88,
         "action":6,
         "request":[],
         "response":[Utils.ByteUtil]
