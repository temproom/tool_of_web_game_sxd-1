package com.protocols
{
   ...
   public class Mod_WeekRanking_Base
   {
      ...
      public static const get_week_ranking:Object = {
         "module":56,
         "action":0,
         "request":[],
         "response":[[Utils.UByteUtil,[Utils.IntUtil,Utils.IntUtil,Utils.StringUtil,Utils.LongUtil,Utils.IntUtil]]]
      };
      
      public static const get_week_ranking_first_player:Object = {
         "module":56,
         "action":1,
         "request":[],
      ...
      public static const notify_week_ranking_type:Object = {
         "module":56,
         "action":2,
         "request":[],
