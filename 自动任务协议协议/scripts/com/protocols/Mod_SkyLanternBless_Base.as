package com.protocols
{
   ...
   public class Mod_SkyLanternBless_Base
   {
      ...
      public static const get_player_info:Object = {
         ...
         "action":2,
         "request":[],
         "response":[Utils.ShortUtil,Utils.ShortUtil,Utils.ByteUtil,Utils.ShortUtil]
      };
      ...
      public static const bless_notify:Object = {
         ...
         "action":4,
         "request":[],
         "response":[Utils.UByteUtil,Utils.ShortUtil,Utils.ShortUtil,Utils.StringUtil,Utils.StringUtil,Utils.StringUtil,Utils.UByteUtil,Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil]
      };
      ...
      public static const get_player_rank_bless_item_id:Object = {
         "module":122,
         "action":9,
         "request":[],
      ...
      public static const choice_rank_bless_item_id:Object = {
         "module":122,
         "action":10,
