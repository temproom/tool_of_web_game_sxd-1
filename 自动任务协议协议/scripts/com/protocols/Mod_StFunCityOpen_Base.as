package com.protocols
{
   ...
   public class Mod_StFunCityOpen_Base
   {
      ...
      public static const open_panel:Object = {
         ...
         "action":0,
         "request":[],
         "response":[Utils.ByteUtil,Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.LongUtil,Utils.LongUtil,Utils.IntUtil]
      };
      ...
      public static const start_answer:Object = {
         ...
         "action":1,
         "request":[],
         "response":[Utils.StringUtil,[Utils.UByteUtil,Utils.StringUtil]]
      };
      ...
      public static const attack_city:Object = {
         "module":285,
         "action":4,
         "request":[Utils.UByteUtil],
      ...
      public static const get_zhan_yao_info:Object = {
         "module":285,
         "action":6,
         "request":[],
      ...
      public static const notify_zhan_yao_refresh:Object = {
         "module":285,
         "action":7,
         "request":[],
      ...
      public static const zhan_yao_fight:Object = {
         "module":285,
         "action":8,
         "request":[],
      ...
      public static const notify_total_value_change:Object = {
         "module":285,
         "action":9,
         "request":[],
      ...
      public static const get_by_mailer_state:Object = {
         "module":285,
         "action":11,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const award_mailer_item:Object = {
         "module":285,
         "action":12,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const get_activity_finish_info:Object = {
         "module":285,
         "action":13,
         "request":[],
