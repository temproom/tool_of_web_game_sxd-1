package com.protocols
{
   ...
   public class Mod_AddupRechargeActivity_Base
   {
      ...
      public static const FAILURE:int = 13;
      ...
      public static const get_player_addup_recharge_info:Object = {
         "module":318,
         "action":1,
         "request":[],
         "response":[[Utils.ShortUtil,Utils.IntUtil,[Utils.IntUtil,Utils.IntUtil],Utils.UByteUtil],[Utils.ShortUtil,[Utils.IntUtil,Utils.IntUtil]],Utils.ShortUtil,[Utils.ShortUtil,Utils.UByteUtil],Utils.IntUtil,Utils.IntUtil,Utils.IntUtil]
      };
      
      public static const get_addup_recharge_li_bao:Object = {
         "module":318,
         "action":2,
      ...
      public static const get_addup_recharge_extra_award:Object = {
         "module":318,
         "action":3,
         "request":[Utils.ShortUtil],
         "response":[Utils.UByteUtil]
      ...
      public static const notify_charge_result:Object = {
         "module":318,
         "action":4,
         "request":[],
         "response":[Utils.UByteUtil]
