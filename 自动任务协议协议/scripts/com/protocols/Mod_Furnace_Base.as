package com.protocols
{
   ...
   public class Mod_Furnace_Base
   {
      ...
      public static const player_role_info:Object = {
         "module":54,
         "action":0,
         "request":[],
         "response":[[Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.ByteUtil],[Utils.IntUtil,Utils.IntUtil]]
      };
      
      public static const make_favor_item:Object = {
         "module":54,
         "action":1,
         "request":[Utils.IntUtil,Utils.UByteUtil],
         "response":[Utils.UByteUtil,[Utils.UByteUtil,Utils.IntUtil,Utils.ByteUtil],Utils.UByteUtil,Utils.ByteUtil,Utils.IntUtil,Utils.ShortUtil]
      };
      
      public static const submit_favor_item:Object = {
         "module":54,
         "action":2,
      ...
      public static const role_level_up:Object = {
         "module":54,
         "action":3,
         "request":[Utils.IntUtil],
      ...
      public static const get_level_up_award:Object = {
         "module":54,
         "action":4,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil,Utils.IntUtil]
      ...
      public static const get_player_favor_info:Object = {
         "module":54,
         "action":5,
         "request":[Utils.IntUtil],
