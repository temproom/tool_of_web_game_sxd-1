package com.protocols
{
   ...
   public class Mod_FiveElementsPalace_Base
   {
      ...
      public static const PASS:int = 3;
      
      public static const NOT_PASS:int = 4;
      
      public static const FASTEST_KILL:int = 5;
      
      public static const BEST_KILL:int = 6;
      
      public static const TRUE:int = 7;
      
      public static const FALSE:int = 8;
      
      public static const USED:int = 9;
      
      public static const UNDEPLOYED:int = 10;
      
      public static const DEPLOYED:int = 11;
      
      public static const TIBU:int = 12;
      
      public static const NOT_EXIST_GRID:int = 13;
      
      public static const ONDEPLOY_LIMIT:int = 14;
      
      public static const PLAYER_ROLE_ID_LOCK:int = 15;
      
      public static const MAIN_ROLE_LIMIT:int = 16;
      
      public static const LEAVE_TEAM:int = 17;
      
      public static const COMPLETE_ALL:int = 18;
      
      public static const CD_TIME:int = 19;
      
      public static const NEED_DEPLOY:int = 20;
      
      public static const FIGHTEN:int = 21;
      
      public static const ITEM_PACK_FULL:int = 22;
      
      public static const NOT_BOSS_LEVEL:int = 23;
      
      public static const NO_FIGHTED:int = 24;
      
      public static const five_elements_info:Object = {
         "module":453,
         "action":0,
         "request":[],
      ...
      public static const kill_rank_list:Object = {
         "module":453,
         "action":7,
         "request":[],
      ...
      public static const Actions:Array = ["five_elements_info","get_deploy","deploy","fight","fight_boss","reset_pass","rank_list","kill_rank_list","get_player_war_report"];
       
      
      public function Mod_FiveElementsPalace_Base()
      {
         super();
      }
   }
