package com.protocols
{
   ...
   public class Mod_StJinBangTiMing_Base
   {
      ...
      public static const get_activity_time_status_info:Object = {
         "module":237,
         "action":0,
         "request":[],
      ...
      public static const get_player_jin_bang_info:Object = {
         "module":237,
         "action":1,
         "request":[],
      ...
      public static const start_answer:Object = {
         ...
         "action":2,
         "request":[],
         "response":[Utils.UByteUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.ShortUtil,Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.StringUtil]
      };
      ...
      public static const submit_answer:Object = {
         ...
         "response":[Utils.UByteUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.UByteUtil]
      };
      ...
      public static const get_rank_info:Object = {
         ...
         "action":4,
         "request":[],
         "response":[[Utils.UByteUtil,[Utils.IntUtil,Utils.IntUtil,Utils.StringUtil,Utils.StringUtil,Utils.StringUtil,Utils.ShortUtil,Utils.IntUtil,Utils.IntUtil]]]
      };
      ...
      public static const answer_notify:Object = {
         "module":237,
         "action":12,
         "request":[],
         "response":[Utils.UByteUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.UByteUtil]
      };
