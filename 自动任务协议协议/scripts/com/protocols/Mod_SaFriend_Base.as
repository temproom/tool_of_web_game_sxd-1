package com.protocols
{
   ...
   public class Mod_SaFriend_Base
   {
      ...
      public static const send_message_to_friend:Object = {
         ...
         "response":[Utils.UByteUtil,Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.StringUtil,Utils.StringUtil,Utils.StringUtil,Utils.IntUtil,Utils.UByteUtil,Utils.IntUtil]
      };
      ...
      public static const receive_message_from_friend:Object = {
         ...
         "action":4,
         "request":[],
         "response":[Utils.IntUtil,Utils.StringUtil,Utils.StringUtil,Utils.StringUtil,Utils.StringUtil,Utils.IntUtil,Utils.UByteUtil,Utils.IntUtil]
      };
      ...
      public static const get_friend_list:Object = {
         ...
         "response":[Utils.IntUtil,[Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil,Utils.StringUtil,Utils.StringUtil,Utils.IntUtil]]
      };
      ...
      public static const get_friendinfo_chatrecord_list:Object = {
         ...
         "action":6,
         "request":[Utils.IntUtil],
         "response":[Utils.IntUtil,Utils.IntUtil,Utils.StringUtil,Utils.StringUtil,Utils.UByteUtil,[Utils.IntUtil,Utils.StringUtil,Utils.StringUtil,Utils.StringUtil,Utils.IntUtil,Utils.UByteUtil,Utils.IntUtil],Utils.IntUtil]
      };
      ...
      public static const get_listeners:Object = {
         ...
         "action":12,
         "request":[],
         "response":[[Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.UByteUtil,Utils.IntUtil]]
      };
      ...
      public static const vip_player_list:Object = {
         ...
         "action":13,
         "request":[],
         "response":[[Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil]]
      };
      ...
      public static const message_box_list:Object = {
         ...
         "action":14,
         "request":[],
         "response":[[Utils.IntUtil,Utils.StringUtil,Utils.StringUtil,Utils.StringUtil,Utils.StringUtil,Utils.IntUtil]]
      };
      ...
      public static const add_favourite_friend:Object = {
         "module":398,
         "action":17,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil]
      ...
      public static const cancel_favourite_friend:Object = {
         "module":398,
         "action":18,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil]
      ...
      public static const notify_friend_focused:Object = {
         "module":398,
         "action":19,
         "request":[],
      ...
      public static const Actions:Array = ["add_friend","add_to_black","delete_friend","send_message_to_friend","receive_message_from_friend","get_friend_list","get_friendinfo_chatrecord_list","check_receive_message","notify_online_state","notify_message_count","get_unreceive_friend_list","get_group","get_listeners","vip_player_list","message_box_list","notify_enter_state","receive_friend_enter_state","add_favourite_friend","cancel_favourite_friend","notify_friend_focused"];
       
      
      public function Mod_SaFriend_Base()
      {
         super();
      }
   }
