package com.protocols
{
   ...
   public class Mod_SuperPrizePool_Base
   {
      ...
      public static const get_player_info:Object = {
         ...
         "action":1,
         "request":[],
         "response":[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,[Utils.ShortUtil,Utils.IntUtil,Utils.IntUtil],Utils.IntUtil,Utils.IntUtil]
      };
      
      public static const start_lottery:Object = {
         "module":203,
         "action":2,
         "request":[],
         "response":[Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.ShortUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil]
      };
      ...
      public static const notify:Object = {
         ...
         "action":5,
         "request":[],
         "response":[Utils.UByteUtil,[Utils.IntUtil,Utils.StringUtil,Utils.StringUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil]]
      };
      
      public static const close_super_prize_pool:Object = {
         "module":203,
         "action":6,
         "request":[],
         "response":[]
      ...
      public static const get_award_list:Object = {
         "module":203,
         "action":7,
         "request":[],
      ...
      public static const notify_server_ticket_change:Object = {
         "module":203,
         "action":8,
         "request":[],
         "response":[Utils.IntUtil,Utils.IntUtil]
