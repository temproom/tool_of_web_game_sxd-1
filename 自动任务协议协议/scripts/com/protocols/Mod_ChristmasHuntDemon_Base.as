package com.protocols
{
   ...
   public class Mod_ChristmasHuntDemon_Base
   {
      ...
      public static const open_christmas_hunt_demon:Object = {
         "module":130,
         "action":0,
         "request":[],
         "response":[Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil]
      };
      
      public static const close_christmas_hunt_demon:Object = {
         "module":130,
         "action":1,
         "request":[],
         "response":[]
      ...
      public static const hunt:Object = {
         "module":130,
         "action":2,
         "request":[],
         "response":[Utils.UByteUtil,[Utils.UByteUtil,Utils.ShortUtil,Utils.IntUtil,Utils.UByteUtil],Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil]
      };
      
      public static const hunt_notify:Object = {
         "module":130,
         "action":3,
         "request":[],
         "response":[Utils.IntUtil,Utils.StringUtil,[Utils.UByteUtil,Utils.ShortUtil,Utils.IntUtil,Utils.UByteUtil]]
      };
      
      public static const active_time:Object = {
         "module":130,
         "action":4,
         "request":[],
      ...
      public static const get_player_choose_info:Object = {
         "module":130,
         "action":5,
         "request":[],
      ...
      public static const get_suit:Object = {
         "module":130,
         "action":7,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const get_lun_hui_stone:Object = {
         "module":130,
         "action":8,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const Actions:Array = ["open_christmas_hunt_demon","close_christmas_hunt_demon","hunt","hunt_notify","active_time","get_player_choose_info","choose","get_suit","get_lun_hui_stone"];
