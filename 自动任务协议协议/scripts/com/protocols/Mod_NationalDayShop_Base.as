package com.protocols
{
   ...
   public class Mod_NationalDayShop_Base
   {
      ...
      public static const shop_info:Object = {
         ...
         "action":0,
         "request":[],
         "response":[[Utils.IntUtil,Utils.IntUtil,Utils.LongUtil,Utils.IntUtil,Utils.ByteUtil,Utils.ByteUtil],[Utils.IntUtil,[Utils.IntUtil,Utils.LongUtil],Utils.UByteUtil],Utils.IntUtil,Utils.IntUtil,Utils.LongUtil]
      };
      ...
      public static const get_extra_box:Object = {
         "module":376,
         "action":2,
         "request":[],
         "response":[Utils.UByteUtil,[Utils.IntUtil,Utils.LongUtil]]
