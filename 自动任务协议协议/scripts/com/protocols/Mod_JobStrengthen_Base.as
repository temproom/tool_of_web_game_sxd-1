package com.protocols
{
   ...
   public class Mod_JobStrengthen_Base
   {
      ...
      public static const NEED_FOUR:int = 9;
      
      public static const NEED_FIVE:int = 10;
      
      public static const NEED_SIX:int = 11;
      
      public static const NEED_SEVEN:int = 12;
      
      public static const NEED_EIGHT:int = 13;
      
      public static const get_prop_num:Object = {
         "module":368,
         "action":0,
         "request":[],
      ...
      public static const get_rune_list:Object = {
         "module":368,
         "action":1,
         "request":[],
