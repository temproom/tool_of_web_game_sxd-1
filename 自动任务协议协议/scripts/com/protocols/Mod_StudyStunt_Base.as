package com.protocols
{
   ...
   public class Mod_StudyStunt_Base
   {
      ...
      public static const train_study_stunt:Object = {
         "module":47,
         "action":4,
         "request":[],
      ...
      public static const awake_study_stunt:Object = {
         "module":47,
         "action":5,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil]
      ...
      public static const Actions:Array = ["player_stunt_info","player_study_stunt","player_use_role_stunt_id","player_can_study_stunt","train_study_stunt","awake_study_stunt"];
