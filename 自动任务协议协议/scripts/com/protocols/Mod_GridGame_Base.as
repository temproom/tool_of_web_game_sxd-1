package com.protocols
{
   ...
   public class Mod_GridGame_Base
   {
      ...
      public static const get_grid_game_status:Object = {
         "module":171,
         "action":0,
         "request":[],
      ...
      public static const player_grid_game_info:Object = {
         "module":171,
         "action":1,
         "request":[],
      ...
      public static const award_list:Object = {
         "module":171,
         "action":2,
         "request":[],
         "response":[[Utils.ShortUtil,Utils.ShortUtil,Utils.IntUtil]]
      ...
      public static const do_grid_game:Object = {
         "module":171,
         "action":3,
         "request":[],
         "response":[Utils.UByteUtil,Utils.ShortUtil,Utils.ShortUtil,Utils.IntUtil,[Utils.ShortUtil,Utils.IntUtil]]
      };
