package com.protocols
{
   ...
   public class Mod_LuckyStore_Base
   {
      ...
      public static const NOT_ENOUGH_DUI_HUAN_JUAN:int = 38;
      
      public static const CHARGE_BACK_LEVEL_LIMIT:int = 39;
      
      public static const LUCKY_STORE:int = 40;
      
      public static const BLACK_SHOP:int = 41;
      
      public static const LEVITATE:int = 42;
      
      public static const get_super_box_get_time_and_statu:Object = {
         "module":87,
         "action":1,
         "request":[],
      ...
      public static const open_super_box:Object = {
         "module":87,
         "action":2,
         "request":[],
      ...
      public static const get_player_super_box_get_record:Object = {
         "module":87,
         "action":3,
         "request":[],
         "response":[[Utils.IntUtil,Utils.IntUtil,Utils.StringUtil,Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil]]
      };
      ...
      public static const get_lucky_store_item_list:Object = {
         ...
         "action":5,
         "request":[],
         "response":[[Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil,Utils.UByteUtil,Utils.IntUtil],Utils.ShortUtil]
      };
      ...
      public static const black_shop_item_list:Object = {
         "module":87,
         "action":10,
         "request":[],
      ...
      public static const buy_black_shop_item:Object = {
         "module":87,
         "action":11,
      ...
      public static const notify_auto_refresh_black_store:Object = {
         "module":87,
         "action":12,
         "request":[],
         "response":[Utils.ByteUtil]
      ...
      public static const scrap_item_list:Object = {
         "module":87,
         "action":13,
         "request":[],
         "response":[[Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil]]
      };
      
      public static const buy_scrap_item:Object = {
         "module":87,
         "action":14,
      ...
      public static const link_soul_item_list:Object = {
         "module":87,
         "action":15,
         "request":[],
         "response":[[Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil]]
      };
      
      public static const buy_link_soul_item:Object = {
         "module":87,
         "action":16,
      ...
      public static const notify_auto_refresh_new_store:Object = {
         "module":87,
         "action":17,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const get_charge_back_shop_record:Object = {
         "module":87,
         "action":18,
         "request":[],
      ...
      public static const buy_charge_back_shop_item:Object = {
         "module":87,
         "action":19,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil]
      ...
      public static const player_need_item_list:Object = {
         "module":87,
         "action":20,
         "request":[],
      ...
      public static const refresh_item_info:Object = {
         "module":87,
         "action":21,
         "request":[],
      ...
      public static const refresh_item:Object = {
         "module":87,
         "action":22,
