package com.protocols
{
   ...
   public class Mod_SignInTwo_Base
   {
      ...
      public static const get_player_sign_in_info_two:Object = {
         "module":92,
         "action":0,
         "request":[],
         "response":[Utils.ShortUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.ShortUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.ShortUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.UByteUtil,[Utils.IntUtil],Utils.ByteUtil,Utils.ByteUtil,[Utils.UByteUtil,Utils.UByteUtil],Utils.ByteUtil,[Utils.UByteUtil,Utils.UByteUtil]]
      };
      
      public static const get_ji_and_ma_two:Object = {
         "module":92,
         "action":1,
         "request":[],
      ...
      public static const player_sign_in_two:Object = {
         "module":92,
         "action":2,
         "request":[],
         "response":[Utils.UByteUtil,Utils.UByteUtil,[Utils.IntUtil],Utils.ByteUtil,Utils.ByteUtil,[Utils.UByteUtil,Utils.UByteUtil]]
      };
      
      public static const player_repair_sign_in_two:Object = {
         "module":92,
         "action":3,
         "request":[],
         "response":[Utils.UByteUtil,Utils.UByteUtil,[Utils.IntUtil],Utils.ByteUtil,Utils.ByteUtil,[Utils.UByteUtil,Utils.UByteUtil]]
      ...
      public static const get_total_signed_in_award_two:Object = {
         "module":92,
         "action":4,
      ...
      public static const get_continue_login_award_two:Object = {
         "module":92,
         "action":5,
         "request":[Utils.UByteUtil],
         "response":[Utils.UByteUtil,Utils.ByteUtil,[Utils.UByteUtil,Utils.UByteUtil]]
      };
      
      public static const get_sign_in_status_two:Object = {
         "module":92,
         "action":6,
         "request":[],
         "response":[Utils.UByteUtil,Utils.UByteUtil,Utils.UByteUtil]
