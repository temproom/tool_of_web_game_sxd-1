package com.protocols
{
   ...
   public class Mod_CallOfBoss_Base
   {
      ...
      public static const get_contribute_info:Object = {
         "module":166,
         "action":2,
         "request":[],
      ...
      public static const contribute:Object = {
         "module":166,
         "action":3,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const get_call_of_boss_flag:Object = {
         "module":166,
         "action":4,
         "request":[],
         "response":[Utils.UByteUtil]
