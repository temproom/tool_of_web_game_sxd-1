package com.protocols
{
   ...
   public class Mod_Sigil_Base
   {
      ...
      public static const player_sigil_info:Object = {
         "module":72,
         "action":0,
         "request":[],
         "response":[Utils.ByteUtil,[Utils.ByteUtil,[Utils.IntUtil,Utils.IntUtil],Utils.UByteUtil]]
      };
      ...
      public static const select_sigil_stunt:Object = {
         "module":72,
         "action":2,
         "request":[Utils.ByteUtil],
      ...
      public static const get_cur_use_sigil_stunt:Object = {
         "module":72,
         "action":3,
         "request":[],
      ...
      public static const exchang_fushi:Object = {
         "module":72,
         "action":4,
      ...
      public static const show_fushi:Object = {
         "module":72,
         "action":5,
         "request":[],
