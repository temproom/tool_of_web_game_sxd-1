package com.protocols
{
   ...
   public class Mod_SpecialPartner_Base
   {
      ...
      public static const get_partner_info:Object = {
         "module":67,
         "action":0,
         "request":[],
         "response":[[Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil,[Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil]]]
      };
      
      public static const get_mission_award:Object = {
         "module":67,
         "action":1,
      ...
      public static const ingot_complete:Object = {
         "module":67,
         "action":2,
         "request":[Utils.IntUtil],
      ...
      public static const invite_partner:Object = {
         "module":67,
         "action":3,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil]
