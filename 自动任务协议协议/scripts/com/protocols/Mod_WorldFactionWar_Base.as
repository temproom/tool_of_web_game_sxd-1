package com.protocols
{
   ...
   public class Mod_WorldFactionWar_Base
   {
      ...
      public static const get_race_step:Object = {
         ...
         "action":0,
         "request":[],
         "response":[Utils.ByteUtil,Utils.UByteUtil,Utils.UByteUtil,Utils.ByteUtil,Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,[Utils.UByteUtil,Utils.IntUtil],Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil,Utils.StringUtil,[Utils.StringUtil,Utils.StringUtil],Utils.IntUtil]
      };
      ...
      public static const get_race_list:Object = {
         ...
         "response":[Utils.UByteUtil,[Utils.IntUtil,Utils.StringUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.IntUtil,Utils.StringUtil,Utils.StringUtil,Utils.LongUtil,Utils.IntUtil,Utils.StringUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.IntUtil,Utils.StringUtil,Utils.StringUtil,Utils.LongUtil],[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.StringUtil],[Utils.IntUtil],[Utils.IntUtil],[Utils.IntUtil],[Utils.IntUtil],Utils.IntUtil,[Utils.IntUtil]]
      };
      ...
      public static const get_war_result_list:Object = {
         ...
         "response":[Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil,[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.StringUtil]]
      };
      ...
      public static const get_standings:Object = {
         ...
         "action":3,
         "request":[],
         "response":[Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil,Utils.ByteUtil,[Utils.IntUtil,Utils.StringUtil,Utils.UByteUtil,Utils.IntUtil,Utils.ByteUtil,Utils.IntUtil,Utils.StringUtil]]
      };
      ...
      public static const get_race_standings:Object = {
         ...
         "action":4,
         "request":[],
         "response":[[Utils.UByteUtil,Utils.IntUtil,Utils.StringUtil,[Utils.ByteUtil,Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.StringUtil],Utils.UByteUtil]]
      };
      ...
      public static const get_player_bet:Object = {
         ...
         "action":7,
         "request":[],
         "response":[[Utils.UByteUtil,Utils.ByteUtil,Utils.IntUtil,Utils.StringUtil,Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil]]
      };
      
      public static const bet:Object = {
         "module":49,
         "action":8,
         "request":[Utils.UByteUtil,Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil],
         "response":[Utils.UByteUtil]
      };
      ...
      public static const world_faction_war_single_result:Object = {
         "module":49,
         "action":10,
         "request":[],
      ...
      public static const world_faction_war_report:Object = {
         "module":49,
         "action":11,
         "request":[Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil,Utils.IntUtil],
         "response":[Utils.IntUtil,[Utils.IntUtil,Utils.StringUtil,Utils.ByteUtil,[Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.ByteUtil,Utils.IntUtil,Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil]],Utils.IntUtil,Utils.IntUtil,[Utils.IntUtil]]
      };
      
      public static const fight_member_list:Object = {
         "module":49,
         "action":12,
         "request":[Utils.IntUtil],
         "response":[[Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.ByteUtil,Utils.IntUtil,Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil]]
      };
      
      public static const award_info:Object = {
         "module":49,
         "action":13,
         "request":[],
      ...
      public static const now_figth_faction:Object = {
         "module":49,
         "action":15,
         "request":[Utils.UByteUtil],
         "response":[[Utils.IntUtil]]
      ...
      public static const set_plot:Object = {
         "module":49,
         "action":16,
         "request":[Utils.UByteUtil,Utils.UByteUtil,Utils.ByteUtil,Utils.ByteUtil],
         "response":[Utils.UByteUtil]
      };
      
      public static const get_plot:Object = {
         "module":49,
         "action":17,
         "request":[Utils.UByteUtil,Utils.UByteUtil,Utils.ByteUtil],
