package com.protocols
{
   ...
   public class Mod_CatHunt_Base
   {
      ...
      public static const auto_search_bonus:Object = {
         "module":51,
         "action":0,
         "request":[],
         "response":[Utils.IntUtil,Utils.ByteUtil,[Utils.IntUtil,Utils.UByteUtil,[Utils.UByteUtil,Utils.IntUtil]]]
      };
      
      public static const use_map_search:Object = {
         "module":51,
         "action":1,
         "request":[Utils.UByteUtil],
         "response":[Utils.UByteUtil,Utils.UByteUtil,Utils.IntUtil,Utils.ByteUtil,Utils.IntUtil,Utils.UByteUtil,[Utils.UByteUtil,Utils.IntUtil]]
      };
