package com.protocols
{
   ...
   public class Mod_MagpieActivityLuckyWheel_Base
   {
      ...
      public static const lucky_wheel_info:Object = {
         "module":246,
         "action":0,
         "request":[],
      ...
      public static const qi_xi_gift_info:Object = {
         "module":246,
         "action":2,
         "request":[],
      ...
      public static const get_qi_xi_gift:Object = {
         "module":246,
         "action":3,
         "request":[],
         "response":[Utils.UByteUtil]
