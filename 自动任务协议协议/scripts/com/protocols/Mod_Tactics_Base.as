package com.protocols
{
   ...
   public class Mod_Tactics_Base
   {
      ...
      public static const get_tactics_info:Object = {
         "module":299,
         "action":0,
         "request":[],
      ...
      public static const draw_tactics_exp:Object = {
         "module":299,
         "action":1,
         "request":[Utils.UByteUtil,Utils.IntUtil],
         "response":[Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,[Utils.ByteUtil,Utils.ByteUtil,Utils.UByteUtil],[Utils.ByteUtil,Utils.ByteUtil],[Utils.ByteUtil,Utils.ByteUtil,Utils.UByteUtil],[Utils.UByteUtil]]
      };
      ...
      public static const get_tactics_deploy_info:Object = {
         ...
         "action":11,
         "request":[],
         "response":[Utils.ShortUtil,[Utils.ShortUtil,Utils.UByteUtil,Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil],Utils.IntUtil]
      };
      ...
      public static const set_point:Object = {
         "module":299,
         "action":14,
         "request":[Utils.ShortUtil,[Utils.ByteUtil,Utils.IntUtil]],
         "response":[Utils.UByteUtil]
      };
      ...
      public static const upgrade_eye_skill_level:Object = {
         "module":299,
         "action":16,
         "request":[Utils.ShortUtil],
         "response":[Utils.UByteUtil]
      ...
      public static const draw_tactics_exp_ten:Object = {
         "module":299,
         "action":17,
         "request":[Utils.UByteUtil,Utils.IntUtil],
         "response":[Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,[Utils.ByteUtil,Utils.ByteUtil,Utils.UByteUtil],[Utils.UByteUtil]]
      };
      
      public static const Actions:Array = ["get_tactics_info","draw_tactics_exp","buy_item","get_tactics_deploy_info","set_tactics_deploy","set_eye","set_point","reset_point","upgrade_eye_skill_level","draw_tactics_exp_ten"];
