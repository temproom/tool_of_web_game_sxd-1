package com.protocols
{
   ...
   public class Mod_MazeTreasure_Base
   {
      
      public static const GUARD_RED:int = 0;
      
      public static const GUARD_GOLD:int = 1;
      
      public static const GUARD_PURPLE:int = 2;
      
      public static const GUARD_BLUE:int = 3;
      
      public static const GUARD_GREEN:int = 4;
      
      public static const BARRIER:int = 5;
      
      public static const BOX:int = 6;
      
      public static const SUCCESS:int = 7;
      
      public static const NO_TIMES:int = 8;
      
      public static const SYS_WIN:int = 9;
      
      public static const FAILED:int = 10;
      
      public static const NO_INGOT:int = 11;
      
      public static const MAX_BUY:int = 12;
      
      public static const FULL_TIMES:int = 13;
      
      public static const NO_SCORE:int = 14;
      
      public static const ITEM_PACK_FULL:int = 15;
      
      public static const NO_BOX:int = 16;
      
      public static const open_panel:Object = {
         "module":480,
         "action":1,
         "request":[],
         "response":[Utils.ByteUtil,Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil,Utils.IntUtil,Utils.ByteUtil,Utils.ByteUtil,[Utils.IntUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.UByteUtil]]
      };
      ...
      public static const Actions:Array = ["open_panel","challenge","buy_times","shop_panel","buy_shop_item","open_box"];
       
      
      public function Mod_MazeTreasure_Base()
      {
         super();
      }
   }
