package com.protocols
{
   ...
   public class Mod_RockGame_Base
   {
      ...
      public static const get_rock_game_status:Object = {
         "module":204,
         "action":0,
         "request":[],
      ...
      public static const player_rock_game:Object = {
         "module":204,
         "action":1,
         "request":[],
         "response":[[Utils.ShortUtil,Utils.ShortUtil,Utils.ByteUtil],Utils.ShortUtil,Utils.ShortUtil,Utils.ShortUtil,Utils.ShortUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.IntUtil]
      };
      
      public static const do_rock_game:Object = {
         "module":204,
         "action":2,
      ...
      public static const activate_multiple:Object = {
         "module":204,
         "action":3,
         "request":[],
