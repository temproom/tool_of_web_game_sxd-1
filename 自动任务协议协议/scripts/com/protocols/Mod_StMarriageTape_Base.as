package com.protocols
{
   ...
   public class Mod_StMarriageTape_Base
   {
      ...
      public static const get_tape_info:Object = {
         "module":321,
         "action":0,
         "request":[],
         "response":[Utils.IntUtil,Utils.IntUtil,Utils.StringUtil,Utils.ByteUtil]
      };
      ...
      public static const get_wall_info:Object = {
         ...
         "action":1,
         "request":[],
         "response":[[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.StringUtil,Utils.ByteUtil]]
      };
      ...
      public static const up_to_wall:Object = {
         "module":321,
         "action":3,
         "request":[],
