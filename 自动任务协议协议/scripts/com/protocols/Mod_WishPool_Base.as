package com.protocols
{
   ...
   public class Mod_WishPool_Base
   {
      ...
      public static const get_wish_pool_info:Object = {
         "module":359,
         "action":0,
         "request":[],
         "response":[[Utils.IntUtil,Utils.UByteUtil],Utils.ShortUtil,Utils.ByteUtil,Utils.IntUtil,Utils.UByteUtil,Utils.UByteUtil,Utils.ByteUtil]
      };
      ...
      public static const get_wish_list:Object = {
         ...
         "action":1,
         "request":[],
         "response":[[Utils.IntUtil,Utils.StringUtil,Utils.StringUtil,Utils.StringUtil,[Utils.IntUtil,Utils.UByteUtil],Utils.ShortUtil]]
      };
      
      public static const choose_awards:Object = {
         "module":359,
         "action":2,
      ...
      public static const wish_self:Object = {
         "module":359,
         "action":3,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const speedup:Object = {
         "module":359,
         "action":4,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const wish_other:Object = {
         "module":359,
         "action":5,
         "request":[Utils.IntUtil],
