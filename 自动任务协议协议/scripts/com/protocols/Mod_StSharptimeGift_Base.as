package com.protocols
{
   ...
   public class Mod_StSharptimeGift_Base
   {
      ...
      public static const get_info:Object = {
         ...
         "action":0,
         "request":[],
         "response":[Utils.UByteUtil,Utils.LongUtil,Utils.LongUtil,Utils.IntUtil]
      };
      ...
      public static const global_notify:Object = {
         "module":279,
         "action":2,
         "request":[],
      ...
      public static const coins_change:Object = {
         "module":279,
         "action":4,
         "request":[],
