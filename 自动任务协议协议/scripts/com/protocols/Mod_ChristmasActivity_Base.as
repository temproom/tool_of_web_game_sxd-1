package com.protocols
{
   ...
   public class Mod_ChristmasActivity_Base
   {
      ...
      public static const get_award:Object = {
         ...
         "response":[Utils.UByteUtil,Utils.ByteUtil,Utils.IntUtil,Utils.ShortUtil,Utils.ShortUtil,Utils.ShortUtil,Utils.IntUtil,Utils.IntUtil]
      };
      
      public static const get_award_report:Object = {
         "module":83,
         "action":2,
         "request":[],
      ...
      public static const join_christmas_activity:Object = {
         "module":83,
         "action":3,
         "request":[],
         "response":[]
      ...
      public static const exit_christmas_activity:Object = {
         "module":83,
         "action":4,
         "request":[],
         "response":[]
