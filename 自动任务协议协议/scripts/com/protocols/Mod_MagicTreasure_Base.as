package com.protocols
{
   ...
   public class Mod_MagicTreasure_Base
   {
      ...
      public static const FATE_PACKAGE_FULL:int = 9;
      
      public static const NO_ENOUGH_SCORE:int = 10;
      
      public static const EXCHANGE_LIMIT:int = 11;
      
      public static const NEED_DRAW_TIMES:int = 12;
      
      public static const get_info:Object = {
         "module":239,
         "action":0,
         "request":[],
         "response":[Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,[Utils.IntUtil],[Utils.IntUtil],[Utils.IntUtil],Utils.IntUtil,Utils.ShortUtil,Utils.ShortUtil,Utils.IntUtil,Utils.IntUtil,Utils.ShortUtil,Utils.ShortUtil]
      };
      ...
      public static const use_draw_times_exchange:Object = {
         "module":239,
         "action":3,
         "request":[],
