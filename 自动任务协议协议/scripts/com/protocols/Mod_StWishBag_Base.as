package com.protocols
{
   ...
   public class Mod_StWishBag_Base
   {
      ...
      public static const get_wish_bag_info:Object = {
         "module":375,
         "action":0,
         "request":[],
         "response":[Utils.ShortUtil,Utils.ShortUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.UByteUtil,Utils.UByteUtil,[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil,Utils.UByteUtil]]
      };
      
      public static const make:Object = {
         "module":375,
         "action":1,
         "request":[],
      ...
      public static const get_tree_awards:Object = {
         "module":375,
         "action":4,
         "request":[Utils.ShortUtil],
         "response":[[Utils.IntUtil,Utils.StringUtil,Utils.StringUtil,Utils.StringUtil],Utils.ShortUtil,Utils.ByteUtil]
      };
      
      public static const get_tree_award:Object = {
         "module":375,
         "action":5,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil,[Utils.IntUtil,Utils.IntUtil],Utils.StringUtil,Utils.StringUtil]
      };
      
      public static const get_title_award:Object = {
         "module":375,
         "action":6,
         "request":[],
         "response":[Utils.UByteUtil]
