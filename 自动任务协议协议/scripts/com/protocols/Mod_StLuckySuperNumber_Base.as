package com.protocols
{
   ...
   public class Mod_StLuckySuperNumber_Base
   {
      ...
      public static const get_lucky_super_number_info:Object = {
         "module":311,
         "action":0,
         "request":[],
      ...
      public static const rank_list:Object = {
         ...
         "action":2,
         "request":[],
         "response":[[Utils.StringUtil,Utils.StringUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil],Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil]
      };
