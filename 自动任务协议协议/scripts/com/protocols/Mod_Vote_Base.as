package com.protocols
{
   ...
   public class Mod_Vote_Base
   {
      ...
      public static const ACTIVITY_AWARD_TIME_LIMIT:int = 10;
      
      public static const NO_VOTE:int = 11;
      
      public static const PACKAGE_FULL:int = 12;
      
      public static const get_vote_info:Object = {
         "module":304,
         "action":0,
         "request":[],
         "response":[[Utils.ShortUtil,Utils.ShortUtil,[Utils.IntUtil],Utils.StringUtil],[Utils.ShortUtil,Utils.ShortUtil,Utils.ShortUtil],Utils.IntUtil,[Utils.ShortUtil,Utils.ShortUtil,Utils.ShortUtil,Utils.ShortUtil],Utils.StringUtil]
      };
      
      public static const vote:Object = {
         "module":304,
         "action":1,
         "request":[[Utils.IntUtil,Utils.ShortUtil,[Utils.IntUtil],Utils.StringUtil],Utils.StringUtil],
      ...
      public static const get_invite_list:Object = {
         ...
         "action":5,
         "request":[],
         "response":[Utils.ByteUtil,[Utils.IntUtil,Utils.StringUtil,Utils.UByteUtil,Utils.UByteUtil]]
      };
