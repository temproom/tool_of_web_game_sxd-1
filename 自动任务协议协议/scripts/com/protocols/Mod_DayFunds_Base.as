package com.protocols
{
   ...
   public class Mod_DayFunds_Base
   {
      ...
      public static const is_can_buy_day_funds:Object = {
         "module":360,
         "action":0,
         "request":[],
      ...
      public static const get_day_funds_info:Object = {
         "module":360,
         "action":1,
         "request":[],
         "response":[Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,[Utils.ByteUtil,[Utils.IntUtil,Utils.IntUtil],Utils.ByteUtil,Utils.ByteUtil]]
      };
      
      public static const buy_day_funds:Object = {
         "module":360,
         "action":2,
         "request":[],
      ...
      public static const mark_first_open:Object = {
         "module":360,
         "action":4,
         "request":[],
         "response":[Utils.UByteUtil]
