package com.protocols
{
   ...
   public class Mod_GodWelfare_Base
   {
      ...
      public static const get_god_welfare_info:Object = {
         "module":328,
         "action":0,
         "request":[],
         "response":[Utils.ShortUtil,Utils.UByteUtil,Utils.StringUtil,Utils.StringUtil,Utils.ShortUtil,Utils.IntUtil,Utils.IntUtil]
      };
      
      public static const get_level_award_info:Object = {
         "module":328,
         "action":1,
         "request":[],
         "response":[[Utils.ShortUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil]]
      };
