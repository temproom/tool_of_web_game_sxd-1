package com.protocols
{
   ...
   public class Mod_LostDeploy_Base
   {
      ...
      public static const get_player_lost_deploy_info:Object = {
         "module":228,
         "action":0,
         "request":[],
         "response":[Utils.IntUtil,Utils.IntUtil,Utils.ShortUtil,[Utils.ShortUtil,Utils.UByteUtil],Utils.UByteUtil]
      };
      
      public static const activate_artifact:Object = {
         "module":228,
         "action":1,
         "request":[],
      ...
      public static const get_player_lost_deploy_data:Object = {
         "module":228,
         "action":2,
         "request":[],
      ...
      public static const auto_activate_artifact:Object = {
         "module":228,
         "action":3,
         "request":[],
