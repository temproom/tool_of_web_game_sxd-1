package com.protocols
{
   ...
   public class Mod_FightVirus_Base
   {
      ...
      public static const SCENE1:int = 2;
      
      public static const SCENE2:int = 3;
      
      public static const ITEM_PACK_FULL:int = 4;
      
      public static const NO_ENOUGTH_TIMES:int = 5;
      
      public static const fight_virus_info:Object = {
         "module":514,
         "action":0,
         "request":[],
      ...
      public static const contribute_info:Object = {
         "module":514,
         "action":1,
         "request":[],
         "response":[Utils.ByteUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.IntUtil,Utils.LongUtil,Utils.LongUtil]
      };
      ...
      public static const fight_info:Object = {
         "module":514,
         "action":4,
         "request":[],
         "response":[Utils.IntUtil,Utils.LongUtil,Utils.IntUtil,Utils.LongUtil,Utils.LongUtil,Utils.ShortUtil,Utils.IntUtil,Utils.ShortUtil]
      };
      ...
      public static const update_my_step:Object = {
         "module":514,
         "action":6,
      ...
      public static const finial_panal_info:Object = {
         "module":514,
         "action":7,
         "request":[],
         "response":[Utils.LongUtil,Utils.LongUtil,Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil]
      };
      ...
      public static const Actions:Array = ["fight_virus_info","contribute_info","contribute","pick","fight_info","fight","update_my_step","finial_panal_info","share"];
       
      
      public function Mod_FightVirus_Base()
      {
         super();
      }
   }
