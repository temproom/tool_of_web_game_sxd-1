package com.protocols
{
   ...
   public class Mod_WorshipMars_Base
   {
      ...
      public static const mars_info:Object = {
         "module":41,
         "action":0,
         "request":[],
      ...
      public static const get_blessing_times_and_exp_add:Object = {
         "module":41,
         "action":2,
         "request":[],
      ...
      public static const blessing_times_and_exp_add_notify:Object = {
         "module":41,
         "action":3,
         "request":[],
      ...
      public static const qingming_active_time_list:Object = {
         "module":41,
         "action":5,
         "request":[],
         "response":[Utils.IntUtil,Utils.IntUtil]
