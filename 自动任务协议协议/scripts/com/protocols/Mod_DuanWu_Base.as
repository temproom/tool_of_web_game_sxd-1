package com.protocols
{
   ...
   public class Mod_DuanWu_Base
   {
      ...
      public static const zongzi_state:Object = {
         "module":64,
         "action":0,
         "request":[],
      ...
      public static const get_zongzi:Object = {
         "module":64,
         "action":1,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const worship_state:Object = {
         "module":64,
         "action":2,
         "request":[],
         "response":[Utils.UByteUtil,Utils.IntUtil,[Utils.IntUtil,Utils.StringUtil,Utils.ByteUtil,Utils.IntUtil]]
      };
