package com.protocols
{
   ...
   public class Mod_FingerGuess_Base
   {
      ...
      public static const finger_guess_state:Object = {
         "module":63,
         "action":0,
         "request":[],
         "response":[Utils.UByteUtil,[Utils.IntUtil,Utils.StringUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.IntUtil,Utils.ByteUtil]]
      };
      ...
      public static const award:Object = {
         "module":63,
         "action":3,
         "request":[],
         "response":[Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.ByteUtil]
      };
      
      public static const is_fight:Object = {
         "module":63,
         "action":4,
      ...
      public static const today_times:Object = {
         "module":63,
         "action":5,
         "request":[],
