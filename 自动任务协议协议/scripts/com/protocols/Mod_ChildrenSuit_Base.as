package com.protocols
{
   ...
   public class Mod_ChildrenSuit_Base
   {
      ...
      public static const get_children_suit_info:Object = {
         "module":365,
         "action":0,
         "request":[Utils.IntUtil],
         "response":[[Utils.IntUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.IntUtil],Utils.IntUtil,Utils.IntUtil]
      };
      
      public static const use_suit:Object = {
         "module":365,
         "action":1,
      ...
      public static const show_in_town:Object = {
         "module":365,
         "action":2,
         "request":[Utils.IntUtil,Utils.IntUtil],
         "response":[Utils.UByteUtil]
