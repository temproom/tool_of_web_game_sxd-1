package com.protocols
{
   ...
   public class Mod_Matual_Base
   {
      ...
      public static const matual_info:Object = {
         "module":197,
         "action":1,
         "request":[],
         "response":[[Utils.IntUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil,Utils.IntUtil],Utils.IntUtil,[Utils.IntUtil,Utils.ByteUtil,Utils.ByteUtil,[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil]],[Utils.IntUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.IntUtil],Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil]
      };
      
      public static const invite_matual:Object = {
         "module":197,
         "action":2,
      ...
      public static const invite_info_notify:Object = {
         "module":197,
         "action":3,
         "request":[],
      ...
      public static const send_world_invite:Object = {
         "module":197,
         "action":5,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const world_invite_notify:Object = {
         "module":197,
         "action":6,
         "request":[],
      ...
      public static const accept_world_invite:Object = {
         "module":197,
         "action":7,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil]
      ...
      public static const cancel_matual:Object = {
         "module":197,
         "action":8,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const get_active_award:Object = {
         "module":197,
         "action":9,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil]
