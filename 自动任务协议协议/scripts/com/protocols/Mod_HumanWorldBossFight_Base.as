package com.protocols
{
   ...
   public class Mod_HumanWorldBossFight_Base
   {
      
      public static const SUCCESS:int = 0;
      
      public static const BOSS_LOCK:int = 1;
      
      public static const FIGHT_COUNT_LIMIT:int = 2;
      
      public static const BOSS_DEAD:int = 3;
      
      public static const FAILED:int = 4;
      
      public static const NOT_ENOUGH_INGOT:int = 5;
      
      public static const CHARGE_NUM_NOT_ENOUGH:int = 6;
      
      public static const HAS_GAIN:int = 7;
      
      public static const ERROR_PARAM:int = 8;
      
      public static const PACK_FULL:int = 9;
      
      public static const get_boss_info:Object = {
         "module":530,
         "action":0,
         "request":[Utils.IntUtil],
         "response":[Utils.LongUtil,Utils.IntUtil,Utils.LongUtil,Utils.IntUtil,[Utils.StringUtil,Utils.LongUtil,Utils.IntUtil,Utils.IntUtil],Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.LongUtil]
      };
      ...
      public static const rank_list:Object = {
         ...
         "action":1,
         "request":[],
         "response":[[Utils.IntUtil,Utils.StringUtil,Utils.StringUtil,Utils.StringUtil,Utils.LongUtil,Utils.IntUtil]]
      };
      ...
      public static const get_auto_fight_info:Object = {
         "module":530,
         "action":6,
         "request":[],
      ...
      public static const Actions:Array = ["get_boss_info","rank_list","fight_boss","get_gift_info","notify_new_gift","gain_gift_award","get_auto_fight_info"];
       
      
      public function Mod_HumanWorldBossFight_Base()
      {
         super();
      }
   }
