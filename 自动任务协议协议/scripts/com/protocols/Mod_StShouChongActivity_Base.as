package com.protocols
{
   ...
   public class Mod_StShouChongActivity_Base
   {
      ...
      public static const get_player_shou_chong_info:Object = {
         "module":153,
         "action":2,
         "request":[],
         "response":[Utils.UByteUtil,[Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil],Utils.ShortUtil,Utils.ShortUtil,[Utils.UByteUtil,Utils.IntUtil],Utils.IntUtil]
      };
      
      public static const get_shou_chong_li_bao:Object = {
         "module":153,
         "action":3,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const get_shou_chong_extra_award:Object = {
         "module":153,
         "action":4,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const exchange_attribute_stone:Object = {
         "module":153,
         "action":6,
         "request":[],
