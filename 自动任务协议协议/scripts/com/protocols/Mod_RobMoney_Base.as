package com.protocols
{
   ...
   public class Mod_RobMoney_Base
   {
      ...
      public static const get_rob_money_info:Object = {
         "module":314,
         "action":0,
         "request":[],
      ...
      public static const notify_refresh_ship:Object = {
         "module":314,
         "action":4,
         "request":[],
         "response":[Utils.UByteUtil,[Utils.IntUtil,Utils.UByteUtil,Utils.IntUtil]]
      };
