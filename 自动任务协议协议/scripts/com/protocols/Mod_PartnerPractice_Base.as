package com.protocols
{
   ...
   public class Mod_PartnerPractice_Base
   {
      ...
      public static const HIRED:int = 23;
      
      public static const HIRE_TIME_LIMIT:int = 24;
      
      public static const TIME_LIMIT:int = 25;
      
      public static const get_partner_practice_info:Object = {
         "module":306,
         "action":0,
         "request":[],
         "response":[Utils.IntUtil,[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil,Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.ShortUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,[Utils.ShortUtil,Utils.ShortUtil,Utils.ByteUtil,Utils.ShortUtil,Utils.ShortUtil],Utils.IntUtil,Utils.IntUtil,Utils.IntUtil],Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,[Utils.ShortUtil,Utils.ShortUtil,Utils.ByteUtil,Utils.ShortUtil,Utils.ShortUtil],Utils.IntUtil,Utils.IntUtil]
      };
      ...
      public static const speed_practice:Object = {
         "module":306,
         "action":3,
         "request":[],
         "response":[Utils.UByteUtil,Utils.IntUtil]
      ...
      public static const enter_fight:Object = {
         "module":306,
         "action":5,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const call_mirror:Object = {
         "module":306,
         "action":6,
         "request":[],
         "response":[Utils.UByteUtil,Utils.IntUtil]
      ...
      public static const get_deploy_info:Object = {
         ...
         "action":7,
         "request":[],
         "response":[[Utils.ByteUtil,Utils.IntUtil,Utils.UByteUtil,Utils.StringUtil,Utils.ShortUtil,Utils.ShortUtil,Utils.ShortUtil,Utils.ShortUtil,Utils.ShortUtil]]
      };
      ...
      public static const Actions:Array = ["get_partner_practice_info","select_partner","start_practice","speed_practice","stop_practice","enter_fight","call_mirror","get_deploy_info","deploy","fight","get_role_war_attribute","hire_partner","clean_CD"];
