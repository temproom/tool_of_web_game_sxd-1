package com.protocols
{
   ...
   public class Mod_StTrials_Base
   {
      ...
      public static const FIVE_PACK_FULL:int = 5;
      
      public static const ERROR:int = 6;
      
      public static const FAILD:int = 7;
      
      public static const CAN_NOT_CHALLENGE:int = 8;
      
      public static const active_info:Object = {
         "module":205,
         "action":0,
         "request":[],
         "response":[Utils.ByteUtil,[Utils.ByteUtil],Utils.ByteUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.ByteUtil]
      };
      
      public static const mode_status:Object = {
         "module":205,
         "action":1,
         "request":[],
      ...
      public static const mode_info:Object = {
         "module":205,
         "action":2,
         "request":[Utils.ByteUtil],
         "response":[Utils.ByteUtil,Utils.ByteUtil,Utils.ByteUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.StringUtil,Utils.StringUtil,Utils.IntUtil,Utils.StringUtil]
      };
      ...
      public static const notify_active_status:Object = {
         "module":205,
         "action":4,
         "request":[],
      ...
      public static const notify_pass:Object = {
         "module":205,
         "action":6,
         "request":[],
      ...
      public static const Actions:Array = ["active_info","mode_status","mode_info","get_award","notify_active_status","challenge","notify_pass"];
       
      
      public function Mod_StTrials_Base()
      {
         super();
      }
   }
