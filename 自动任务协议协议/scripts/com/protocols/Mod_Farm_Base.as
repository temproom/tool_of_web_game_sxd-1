package com.protocols
{
   ...
   public class Mod_Farm_Base
   {
      ...
      public static const PACK_FULL:int = 16;
      
      public static const REACH_MAX_LAND_COUNT:int = 17;
      
      public static const NOT_PLAYER_ROLE:int = 18;
      
      public static const IS_MAIN_ROLE:int = 19;
      
      public static const ROLE_LEVEL:int = 20;
      
      public static const PASS:int = 21;
      
      public static const REMAIN:int = 22;
      
      public static const NO_REMAIN:int = 23;
      
      public static const NO_INGOT:int = 24;
      
      public static const LIMIT_NUM:int = 25;
      
      public static const NO_ENOUGTH_TIMES:int = 26;
      
      public static const NO_VIP:int = 27;
      
      public static const IS_PLANT:int = 28;
      
      public static const CAN_NOT_UP:int = 29;
      
      public static const FAILED:int = 30;
      
      public static const NOT_ENOUGTH_COIN:int = 31;
      
      public static const NOT_ENOUGTH_INGOT:int = 32;
      
      public static const ERROR:int = 33;
      
      public static const ITEM_PACK_FULL:int = 34;
      
      public static const get_farmlandinfo_list:Object = {
         "module":13,
         "action":0,
         "request":[],
         "response":[[Utils.IntUtil,Utils.IntUtil,Utils.StringUtil,Utils.StringUtil,Utils.IntUtil,Utils.LongUtil,Utils.LongUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil,Utils.UByteUtil,Utils.ByteUtil],Utils.IntUtil,Utils.IntUtil]
      };
      ...
      public static const xianling_tree_count_notify:Object = {
         "module":13,
         "action":17,
         "request":[],
         "response":[Utils.IntUtil]
      ...
      public static const xianling_tree_count_info:Object = {
         "module":13,
         "action":18,
         "request":[],
         "response":[Utils.IntUtil,Utils.IntUtil]
      ...
      public static const get_new_farmlandinfo_list:Object = {
         "module":13,
         "action":21,
         "request":[],
         "response":[[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil,[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil]],Utils.IntUtil]
      };
      
      public static const new_farmland_herbs_list:Object = {
         "module":13,
         "action":22,
         "request":[],
      ...
      public static const buy_new_herbs:Object = {
         "module":13,
         "action":23,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil]
      ...
      public static const plant_new_herbs:Object = {
         "module":13,
         "action":24,
      ...
      public static const harvest_new:Object = {
         "module":13,
         "action":25,
         "request":[Utils.IntUtil],
      ...
      public static const new_clear_farmland_cd:Object = {
         "module":13,
         "action":26,
         "request":[Utils.IntUtil],
         "response":[Utils.UByteUtil]
