package com.protocols
{
   ...
   public class Mod_Archery_Base
   {
      ...
      public static const act_open_time:Object = {
         "module":215,
         "action":0,
         "request":[],
      ...
      public static const act_info:Object = {
         ...
         "action":1,
         "request":[],
         "response":[Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil,Utils.IntUtil,Utils.ByteUtil,Utils.ByteUtil]
      };
      
      public static const archery_info:Object = {
         "module":215,
         "action":2,
         "request":[],
         "response":[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,[Utils.ByteUtil,Utils.ByteUtil],Utils.ByteUtil]
      };
      ...
      public static const archery:Object = {
         "module":215,
         "action":4,
