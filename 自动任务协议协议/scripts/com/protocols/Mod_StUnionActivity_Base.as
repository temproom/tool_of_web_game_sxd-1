package com.protocols
{
   ...
   public class Mod_StUnionActivity_Base
   {
      ...
      public static const HAS_FINISH:int = 6;
      
      public static const HAD_CHOOSED:int = 7;
      
      public static const BLESS_SUCCESS:int = 8;
      
      public static const WISH_SUCCESS:int = 9;
      
      public static const NO_CHOOSED_ITEM:int = 10;
      
      public static const HAD_WISH:int = 11;
      
      public static const HAD_BLESS:int = 12;
      
      public static const NO_START_WISH:int = 13;
      
      public static const NON_SAME_ST_UNION:int = 14;
      
      public static const BLESS_REQUEST:int = 15;
      
      public static const HAD_GET:int = 16;
      
      public static const NO_ENOUGH_COIN:int = 17;
      
      public static const NO_ENOUGH_INGOT:int = 18;
      
      public static const NO_ENOUGH_VIP:int = 19;
      
      public static const NO_ENOUGH_ST_UNION_LEVEL:int = 20;
      
      public static const POWER_FAME_FUN_NOT_OPEN:int = 21;
      
      public static const TODAY_LIMIT:int = 22;
      ...
      public static const request_bless:Object = {
         "module":179,
         "action":5,
         "request":[],
         "response":[]
      ...
      public static const get_st_union_god_info:Object = {
         "module":179,
         "action":10,
         "request":[],
      ...
      public static const st_union_god_incense:Object = {
         "module":179,
         "action":11,
         "request":[Utils.IntUtil],
