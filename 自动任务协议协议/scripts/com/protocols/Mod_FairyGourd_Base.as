package com.protocols
{
   ...
   public class Mod_FairyGourd_Base
   {
      ...
      public static const get_date:Object = {
         "module":220,
         "action":0,
         "request":[],
      ...
      public static const get_fairy_gourd_list:Object = {
         "module":220,
         "action":1,
         "request":[],
         "response":[[Utils.LongUtil,Utils.LongUtil,Utils.IntUtil]]
      };
      
      public static const get_fairy_gourd:Object = {
         "module":220,
         "action":2,
