package com.protocols
{
   ...
   public class Mod_ScoreGame_Base
   {
      ...
      public static const open_score_game:Object = {
         "module":192,
         "action":1,
         "request":[],
      ...
      public static const play_golden_eggs_game:Object = {
         "module":192,
         "action":2,
         "request":[],
         "response":[Utils.UByteUtil,[Utils.ByteUtil,Utils.ByteUtil],Utils.IntUtil,Utils.ByteUtil]
      };
      
      public static const play_roll_cake:Object = {
         "module":192,
         "action":3,
         "request":[],
      ...
      public static const open_lucky_magic_box:Object = {
         "module":192,
         "action":4,
         "request":[],
         "response":[[Utils.ByteUtil,Utils.ByteUtil],Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil,Utils.ByteUtil]
      };
      
      public static const play_lucky_magic_box:Object = {
         "module":192,
         "action":5,
