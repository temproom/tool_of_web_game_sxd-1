package com.protocols
{
   ...
   public class Mod_PartnerLink_Base
   {
      ...
      public static const CHANGE_TIME_LIMIT:int = 20;
      
      public static const LENGTH_LIMIT:int = 21;
      
      public static const SAME_ID:int = 22;
      
      public static const EMPTY_LIST:int = 23;
      
      public static const QUALITY_LIMIT:int = 24;
      
      public static const get_info:Object = {
         "module":290,
         "action":0,
         "request":[],
         "response":[Utils.ShortUtil,[Utils.ShortUtil,Utils.ShortUtil],[Utils.ShortUtil,Utils.ShortUtil,Utils.ShortUtil,Utils.StringUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil],[Utils.ByteUtil,Utils.UByteUtil,[Utils.ShortUtil,Utils.UByteUtil,Utils.ShortUtil],Utils.UByteUtil]]
      };
      ...
      public static const get_shopping_info:Object = {
         "module":290,
         "action":2,
         "request":[],
         "response":[[Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil,Utils.IntUtil]]
      };
      ...
      public static const get_change_shopping_info:Object = {
         "module":290,
         "action":4,
         "request":[],
      ...
      public static const resolve_item:Object = {
         "module":290,
         "action":5,
      ...
      public static const convert_item:Object = {
         "module":290,
         "action":6,
         "request":[Utils.IntUtil,Utils.IntUtil],
         "response":[Utils.UByteUtil]
      ...
      public static const Actions:Array = ["get_info","activate","get_shopping_info","buy_item","get_change_shopping_info","resolve_item","convert_item","advance","convert_gold_item","get_wish_list","set_wish_list"];
