package com.protocols
{
   ...
   public class Mod_LanternFestival_Base
   {
      ...
      public static const get_award_report:Object = {
         ...
         "action":2,
         "request":[],
         "response":[Utils.UByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.StringUtil]
      };
      
      public static const join_lantern_festival:Object = {
         "module":86,
         "action":3,
         "request":[],
         "response":[]
      ...
      public static const exit_lantern_festival:Object = {
         "module":86,
         "action":4,
         "request":[],
         "response":[]
