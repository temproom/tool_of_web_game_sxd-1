package com.protocols
{
   ...
   public class Mod_HeavenHero_Base
   {
      ...
      public static const monster_deploy:Object = {
         "module":479,
         "action":9,
         "request":[Utils.IntUtil],
         "response":[Utils.IntUtil,[Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil]]
      ...
      public static const Actions:Array = ["panel_info","deploy_info","reset_deploy","gain_min_award","get_deploy_info","up_deploy","down_deploy","save_extra_attr","fight","monster_deploy"];
       
      
      public function Mod_HeavenHero_Base()
      {
         super();
      }
   }
