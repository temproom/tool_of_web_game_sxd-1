package com.protocols
{
   ...
   public class Mod_WishWall_Base
   {
      ...
      public static const get_wish_wall_info:Object = {
         "module":278,
         "action":0,
         "request":[],
         "response":[[Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil],[Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil,Utils.ByteUtil],Utils.IntUtil]
      };
      ...
      public static const notify:Object = {
         ...
         "action":3,
         "request":[],
         "response":[Utils.ByteUtil,[Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.ByteUtil,Utils.ByteUtil],Utils.IntUtil]
      };
