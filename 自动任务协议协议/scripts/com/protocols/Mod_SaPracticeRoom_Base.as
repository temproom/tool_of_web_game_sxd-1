package com.protocols
{
   ...
   public class Mod_SaPracticeRoom_Base
   {
      ...
      public static const DAO_YUAN:int = 17;
      
      public static const INGOT:int = 18;
      
      public static const NO_EXP_TO_GET:int = 19;
      
      public static const FAILURE:int = 20;
      
      public static const NO_ENOUGH_DAOYUAN:int = 21;
      
      public static const NO_IN_PRACTICE:int = 22;
      
      public static const MAX_PRACTICE_TIME:int = 23;
      
      public static const BE_ROBBED:int = 24;
      
      public static const get_rooms:Object = {
         "module":407,
         "action":0,
         "request":[],
      ...
      public static const get_room_info:Object = {
         ...
         "response":[[Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.StringUtil,Utils.StringUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil],Utils.IntUtil,Utils.IntUtil,Utils.ShortUtil,Utils.ByteUtil,Utils.UByteUtil,Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil]
      };
      ...
      public static const get_seat_info:Object = {
         "module":407,
         "action":3,
         "request":[Utils.ByteUtil,Utils.ByteUtil],
         "response":[Utils.UByteUtil]
      ...
      public static const buy_rob_time:Object = {
         "module":407,
         "action":5,
         "request":[],
      ...
      public static const get_room_practice_exp:Object = {
         "module":407,
         "action":6,
      ...
      public static const get_exp_flag:Object = {
         "module":407,
         "action":7,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const get_rob_cd_time:Object = {
         "module":407,
         "action":11,
         "request":[],
      ...
      public static const notify_refresh_exp:Object = {
         "module":407,
         "action":12,
         "request":[],
      ...
      public static const player_leave_seat:Object = {
         "module":407,
         "action":13,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const get_player_room_quality:Object = {
         "module":407,
         "action":14,
         "request":[],
      ...
      public static const notify_practice_room_msg:Object = {
         "module":407,
         "action":15,
         "request":[],
         "response":[Utils.UByteUtil]
      ...
      public static const get_free_room_info:Object = {
         "module":407,
         "action":16,
         "request":[],
         "response":[Utils.ShortUtil,Utils.ShortUtil,Utils.IntUtil,Utils.IntUtil,Utils.ShortUtil,Utils.ShortUtil,Utils.ByteUtil,Utils.UByteUtil,Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil]
      };
      
      public static const get_free_room_info_by_page:Object = {
         "module":407,
         "action":17,
         "request":[Utils.ShortUtil],
         "response":[[Utils.ByteUtil,Utils.IntUtil,Utils.IntUtil,Utils.IntUtil,Utils.StringUtil,Utils.StringUtil,Utils.StringUtil,Utils.IntUtil,Utils.IntUtil,Utils.UByteUtil]]
      };
      ...
      public function Mod_SaPracticeRoom_Base()
      {
         super();
      }
   }
